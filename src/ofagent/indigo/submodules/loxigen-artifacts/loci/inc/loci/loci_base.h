...
typedef enum of_object_id_e {
    ...
    OFDPA_CLASS_BASED_CTR_MOD_MSG = 182,
    OFDPA_CLASS_BASED_CTR_MULTIPART_REPLY = 183,
    OFDPA_CLASS_BASED_CTR_MULTIPART_REQUEST = 184,
    OFDPA_COLOR_BASED_CTR_MOD_MSG = 185,
    OFDPA_COLOR_BASED_CTR_MULTIPART_REPLY = 186,
    OFDPA_COLOR_BASED_CTR_MULTIPART_REQUEST = 187,
    OFDPA_L2_INTERFACE_REMARK_ACTION_MOD_MSG = 188,
    OFDPA_L2_INTERFACE_REMARK_ACTION_MULTIPART_REPLY = 189,
    OFDPA_L2_INTERFACE_REMARK_ACTION_MULTIPART_REQUEST = 190,
    OFDPA_MPLS_SET_QOS_ACTION_MOD_MSG = 191,
    OFDPA_MPLS_SET_QOS_ACTION_MULTIPART_REPLY = 192,
    OFDPA_MPLS_SET_QOS_ACTION_MULTIPART_REQUEST = 193,
    OFDPA_MPLS_TUNNEL_LABEL_MULTIPART_REPLY = 194,
    OFDPA_MPLS_TUNNEL_LABEL_MULTIPART_REQUEST = 195,
    OFDPA_MPLS_TUNNEL_LABEL_REMARK_ACTION_MOD_MSG = 196,
    OFDPA_MPLS_VPN_LABEL_REMARK_ACTION_MOD_MSG = 197,
    OFDPA_MPLS_VPN_LABEL_REMARK_ACTION_MULTIPART_REPLY = 198,
    OFDPA_MPLS_VPN_LABEL_REMARK_ACTION_MULTIPART_REQUEST = 199,
    OFDPA_OAM_DATAPLANE_CTR_MOD_MSG = 200,
    OFDPA_OAM_DATAPLANE_CTR_MULTIPART_REPLY = 201,
    OFDPA_OAM_DATAPLANE_CTR_MULTIPART_REQUEST = 202,
    OFDPA_OAM_DROP_STATUS_MOD_MSG = 203,
    OFDPA_OAM_DROP_STATUS_MULTIPART_REPLY = 204,
    OFDPA_OAM_DROP_STATUS_MULTIPART_REQUEST = 205,
    OFDPA_PORT_EXPERIMENTER_PROP_SCHEDULING = 206,
    OFDPA_QUEUE_DESC_PROP_CONGESTION_MULTIPART_REPLY = 207,
    OFDPA_QUEUE_DESC_PROP_CONGESTION_MULTIPART_REQUEST = 208,
    OFDPA_QUEUE_DESC_PROP_PARENT_MULTIPART_REPLY = 209,
    OFDPA_QUEUE_DESC_PROP_PARENT_MULTIPART_REQUEST = 210,
    OFDPA_QUEUE_MOD = 211,
    OFDPA_SCHEDULER_NODE_MOD_MSG = 212,
    OFDPA_SCHEDULER_NODE_MULTIPART_REQUEST = 213,
    OFDPA_SCHEDULER_NODE_MULTIPART_RESPONSE = 214,

    /* Non-message objects */
    OF_ACTION = 215,
    OF_ACTION_BSN = 216,
    OF_ACTION_BSN_MIRROR = 217,
    OF_ACTION_BSN_SET_TUNNEL_DST = 218,
    OF_ACTION_COPY_TTL_IN = 219,
    OF_ACTION_COPY_TTL_OUT = 220,
    OF_ACTION_DEC_MPLS_TTL = 221,
    OF_ACTION_DEC_NW_TTL = 222,
    OF_ACTION_ENQUEUE = 223,
    OF_ACTION_EXPERIMENTER = 224,
    OF_ACTION_GROUP = 225,
    OF_ACTION_HEADER = 226,
    OF_ACTION_ID = 227,
    OF_ACTION_ID_BSN = 228,
    OF_ACTION_ID_BSN_MIRROR = 229,
    OF_ACTION_ID_BSN_SET_TUNNEL_DST = 230,
    OF_ACTION_ID_COPY_TTL_IN = 231,
    OF_ACTION_ID_COPY_TTL_OUT = 232,
    OF_ACTION_ID_DEC_MPLS_TTL = 233,
    OF_ACTION_ID_DEC_NW_TTL = 234,
    OF_ACTION_ID_EXPERIMENTER = 235,
    OF_ACTION_ID_GROUP = 236,
    OF_ACTION_ID_HEADER = 237,
    OF_ACTION_ID_NICIRA = 238,
    OF_ACTION_ID_NICIRA_DEC_TTL = 239,
    OF_ACTION_ID_OFDPA = 240,
    OF_ACTION_ID_OFDPA_CHECK_DROP_STATUS = 241,
    OF_ACTION_ID_OFDPA_CLASS_BASED_RX_COUNT = 242,
    OF_ACTION_ID_OFDPA_CLASS_BASED_TX_COUNT = 243,
    OF_ACTION_ID_OFDPA_COLOR_BASED_RX_COUNT = 244,
    OF_ACTION_ID_OFDPA_COLOR_BASED_TX_COUNT = 245,
    OF_ACTION_ID_OFDPA_COPY_TC_IN = 246,
    OF_ACTION_ID_OFDPA_COPY_TC_OUT = 247,
    OF_ACTION_ID_OFDPA_DEC_TTL_MTU = 248,
    OF_ACTION_ID_OFDPA_OAM_LM_RX_COUNT = 249,
    OF_ACTION_ID_OFDPA_OAM_LM_TX_COUNT = 250,
    OF_ACTION_ID_OFDPA_POP_CW = 251,
    OF_ACTION_ID_OFDPA_POP_L2HDR = 252,
    OF_ACTION_ID_OFDPA_PUSH_CW = 253,
    OF_ACTION_ID_OFDPA_PUSH_L2HDR = 254,
    OF_ACTION_ID_OFDPA_SET_COUNTER_FIELDS = 255,
    OF_ACTION_ID_OFDPA_SET_MPLS_PCPDEI_FROM_TABLE = 256,
    OF_ACTION_ID_OFDPA_SET_MPLS_PCPDEI_FROM_TUNNEL_TABLE = 257,
    OF_ACTION_ID_OFDPA_SET_MPLS_QOS_FROM_TABLE = 258,
    OF_ACTION_ID_OFDPA_SET_MPLS_TC_FROM_TUNNEL_TABLE = 259,
    OF_ACTION_ID_OFDPA_SET_MPLS_TC_FROM_VPN_TABLE = 260,
    OF_ACTION_ID_OFDPA_SET_PCPDEI_FROM_TABLE = 261,
    OF_ACTION_ID_OUTPUT = 262,
    OF_ACTION_ID_POP_MPLS = 263,
    OF_ACTION_ID_POP_PBB = 264,
    OF_ACTION_ID_POP_VLAN = 265,
    OF_ACTION_ID_PUSH_MPLS = 266,
    OF_ACTION_ID_PUSH_PBB = 267,
    OF_ACTION_ID_PUSH_VLAN = 268,
    OF_ACTION_ID_SET_FIELD = 269,
    OF_ACTION_ID_SET_MPLS_TTL = 270,
    OF_ACTION_ID_SET_NW_TTL = 271,
    OF_ACTION_ID_SET_QUEUE = 272,
    OF_ACTION_NICIRA = 273,
    OF_ACTION_NICIRA_DEC_TTL = 274,
    OF_ACTION_OFDPA = 275,
    OF_ACTION_OFDPA_CHECK_DROP_STATUS = 276,
    OF_ACTION_OFDPA_CLASS_BASED_RX_COUNT = 277,
    OF_ACTION_OFDPA_CLASS_BASED_TX_COUNT = 278,
    OF_ACTION_OFDPA_COLOR_BASED_RX_COUNT = 279,
    OF_ACTION_OFDPA_COLOR_BASED_TX_COUNT = 280,
    ...
    OF_ACTION_OFDPA_SET_MPLS_QOS_FROM_TABLE = 293,
    OF_ACTION_OFDPA_SET_MPLS_TC_FROM_TUNNEL_TABLE = 294,
    OF_ACTION_OFDPA_SET_MPLS_TC_FROM_VPN_TABLE = 295,
    OF_ACTION_OFDPA_SET_PCPDEI_FROM_TABLE = 296,
    OF_ACTION_OUTPUT = 297,
    OF_ACTION_POP_MPLS = 298,
    OF_ACTION_POP_PBB = 299,
    OF_ACTION_POP_VLAN = 300,
    OF_ACTION_PUSH_MPLS = 301,
    OF_ACTION_PUSH_PBB = 302,
    OF_ACTION_PUSH_VLAN = 303,
    OF_ACTION_SET_DL_DST = 304,
    OF_ACTION_SET_DL_SRC = 305,
    OF_ACTION_SET_FIELD = 306,
    OF_ACTION_SET_MPLS_LABEL = 307,
    OF_ACTION_SET_MPLS_TC = 308,
    OF_ACTION_SET_MPLS_TTL = 309,
    OF_ACTION_SET_NW_DST = 310,
    OF_ACTION_SET_NW_ECN = 311,
    OF_ACTION_SET_NW_SRC = 312,
    OF_ACTION_SET_NW_TOS = 313,
    OF_ACTION_SET_NW_TTL = 314,
    OF_ACTION_SET_QUEUE = 315,
    OF_ACTION_SET_TP_DST = 316,
    OF_ACTION_SET_TP_SRC = 317,
    OF_ACTION_SET_VLAN_PCP = 318,
    OF_ACTION_SET_VLAN_VID = 319,
    OF_ACTION_STRIP_VLAN = 320,
    OF_BSN_CONTROLLER_CONNECTION = 321,
    OF_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 322,
    OF_BSN_DEBUG_COUNTER_STATS_ENTRY = 323,
    OF_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 324,
    OF_BSN_GENTABLE_BUCKET_STATS_ENTRY = 325,
    OF_BSN_GENTABLE_DESC_STATS_ENTRY = 326,
    OF_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 327,
    OF_BSN_GENTABLE_ENTRY_STATS_ENTRY = 328,
    OF_BSN_GENTABLE_STATS_ENTRY = 329,
    OF_BSN_INTERFACE = 330,
    OF_BSN_LACP_STATS_ENTRY = 331,
    OF_BSN_PORT_COUNTER_STATS_ENTRY = 332,
    OF_BSN_SWITCH_PIPELINE_STATS_ENTRY = 333,
    OF_BSN_TABLE_CHECKSUM_STATS_ENTRY = 334,
    OF_BSN_TLV = 335,
    OF_BSN_TLV_BROADCAST_QUERY_TIMEOUT = 336,
    OF_BSN_TLV_CIRCUIT_ID = 337,
    OF_BSN_TLV_HEADER = 338,
    ...
    OF_BSN_TLV_PORT = 345,
    OF_BSN_TLV_REPLY_PACKETS = 346,
    OF_BSN_TLV_REQUEST_PACKETS = 347,
    OF_BSN_TLV_RX_PACKETS = 348,
    OF_BSN_TLV_TX_PACKETS = 349,
    OF_BSN_TLV_UDF_ANCHOR = 350,
    OF_BSN_TLV_UDF_ID = 351,
    OF_BSN_TLV_UDF_LENGTH = 352,
    OF_BSN_TLV_UDF_OFFSET = 353,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 354,
    OF_BSN_TLV_VLAN_VID = 355,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 356,
    OF_BSN_VPORT = 357,
    OF_BSN_VPORT_HEADER = 358,
    OF_BSN_VPORT_Q_IN_Q = 359,
    OF_BUCKET = 360,
    OF_BUCKET_COUNTER = 361,
    OF_FLOW_STATS_ENTRY = 362,
    OF_GROUP_DESC_STATS_ENTRY = 363,
    OF_GROUP_STATS_ENTRY = 364,
    OF_HEADER = 365,
    OF_HELLO_ELEM = 366,
    OF_HELLO_ELEM_HEADER = 367,
    OF_HELLO_ELEM_VERSIONBITMAP = 368,
    OF_INSTRUCTION = 369,
    OF_INSTRUCTION_APPLY_ACTIONS = 370,
    OF_INSTRUCTION_BSN = 371,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 372,
    OF_INSTRUCTION_BSN_DENY = 373,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 374,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 375,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 376,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 377,
    OF_INSTRUCTION_BSN_PERMIT = 378,
    ...
    OF_METER_BAND_OFDPA_COLOR_SET = 411,
    ...
    OF_OXM_BSN_VRF = 457,
    OF_OXM_BSN_VRF_MASKED = 458,
    OF_OXM_ETH_DST = 459,
    OF_OXM_ETH_DST_MASKED = 460,
    OF_OXM_ETH_SRC = 461,
    OF_OXM_ETH_SRC_MASKED = 462,
    OF_OXM_ETH_TYPE = 463,
    OF_OXM_ETH_TYPE_MASKED = 464,
    OF_OXM_HEADER = 465,
    ...
    OF_OXM_IPV6_FLABEL = 490,
    OF_OXM_IPV6_FLABEL_MASKED = 491,
    OF_OXM_IPV6_ND_SLL = 492,
    OF_OXM_IPV6_ND_SLL_MASKED = 493,
    OF_OXM_IPV6_ND_TARGET = 494,
    OF_OXM_IPV6_ND_TARGET_MASKED = 495,
    OF_OXM_IPV6_ND_TLL = 496,
    OF_OXM_IPV6_ND_TLL_MASKED = 497,
    OF_OXM_IPV6_SRC = 498,
    OF_OXM_IPV6_SRC_MASKED = 499,
    OF_OXM_METADATA = 500,
    OF_OXM_METADATA_MASKED = 501,
    OF_OXM_MPLS_BOS = 502,
    OF_OXM_MPLS_BOS_MASKED = 503,
    OF_OXM_MPLS_LABEL = 504,
    OF_OXM_MPLS_LABEL_MASKED = 505,
    OF_OXM_MPLS_TC = 506,
    OF_OXM_MPLS_TC_MASKED = 507,
    OF_OXM_OFDPA_ALLOW_VLAN_TRANSLATION = 508,
    OF_OXM_OFDPA_BFD_DISCRIMINATOR = 509,
    OF_OXM_OFDPA_BFD_DISCRIMINATOR_MASKED = 510,
    OF_OXM_OFDPA_COLOR = 511,
    OF_OXM_OFDPA_COLOR_ACTIONS_INDEX = 512,
    OF_OXM_OFDPA_DEI = 513,
    OF_OXM_OFDPA_L3_IN_PORT = 514,
    OF_OXM_OFDPA_LMEP_ID = 515,
    OF_OXM_OFDPA_MPLS_ACH_CHANNEL = 516,
    OF_OXM_OFDPA_MPLS_DATA_FIRST_NIBBLE = 517,
    OF_OXM_OFDPA_MPLS_L2_PORT = 518,
    OF_OXM_OFDPA_MPLS_L2_PORT_MASKED = 519,
    OF_OXM_OFDPA_MPLS_NEXT_LABEL_IS_GAL = 520,
    OF_OXM_OFDPA_MPLS_TTL = 521,
    OF_OXM_OFDPA_MPLS_TYPE = 522,
    OF_OXM_OFDPA_OAM_Y1731_MDL = 523,
    OF_OXM_OFDPA_OAM_Y1731_OPCODE = 524,
    OF_OXM_OFDPA_OVID = 525,
    OF_OXM_OFDPA_PROTECTION_INDEX = 526,
    OF_OXM_OFDPA_QOS_INDEX = 527,
    OF_OXM_OFDPA_RX_TIMESTAMP = 528,
    OF_OXM_OFDPA_RXFCL = 529,
    OF_OXM_OFDPA_TRAFFIC_CLASS = 530,
    OF_OXM_OFDPA_TXFCL = 531,
    OF_OXM_OFDPA_VRF = 532,
    OF_OXM_ONF_ACTSET_OUTPUT = 533,
    OF_OXM_SCTP_DST = 534,
    OF_OXM_SCTP_DST_MASKED = 535,
    OF_OXM_SCTP_SRC = 536,
    OF_OXM_SCTP_SRC_MASKED = 537,
    OF_OXM_TCP_DST = 538,
    OF_OXM_TCP_DST_MASKED = 539,
    OF_OXM_TCP_SRC = 540,
    OF_OXM_TCP_SRC_MASKED = 541,
    OF_OXM_TUNNEL_ID = 542,
    OF_OXM_TUNNEL_ID_MASKED = 543,
    OF_OXM_UDP_DST = 544,
    ...
    OF_PACKET_QUEUE = 552,
    OF_PORT_DESC = 553,
    OF_PORT_STATS_ENTRY = 554,
    OF_QUEUE_PROP = 555,
    OF_QUEUE_PROP_EXPERIMENTER = 556,
    OF_QUEUE_PROP_HEADER = 557,
    OF_QUEUE_PROP_MAX_RATE = 558,
    OF_QUEUE_PROP_MIN_RATE = 559,
    OF_QUEUE_STATS_ENTRY = 560,
    ...
    OF_TABLE_FEATURE_PROP_HEADER = 568,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 569,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 570,
    OF_TABLE_FEATURE_PROP_MATCH = 571,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 572,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 573,
    ...
    /* List objects */
    OF_LIST_ACTION = 585,
    OF_LIST_ACTION_ID = 586,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 587,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 588,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 589,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 590,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 591,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 592,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 593,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 594,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 595,
    OF_LIST_BSN_INTERFACE = 596,
    OF_LIST_BSN_LACP_STATS_ENTRY = 597,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 598,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 599,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 600,
    OF_LIST_BSN_TLV = 601,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 602,
    OF_LIST_BUCKET = 603,
    OF_LIST_BUCKET_COUNTER = 604,
    OF_LIST_FLOW_STATS_ENTRY = 605,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 606,
    OF_LIST_GROUP_STATS_ENTRY = 607,
    OF_LIST_HELLO_ELEM = 608,
    OF_LIST_INSTRUCTION = 609,
    OF_LIST_INSTRUCTION_ID = 610,
    OF_LIST_METER_BAND = 611,
    OF_LIST_METER_BAND_STATS = 612,
    OF_LIST_METER_STATS = 613,
    OF_LIST_OXM = 614,
    OF_LIST_PACKET_QUEUE = 615,
    OF_LIST_PORT_DESC = 616,
    OF_LIST_PORT_STATS_ENTRY = 617,
    OF_LIST_QUEUE_PROP = 618,
    OF_LIST_QUEUE_STATS_ENTRY = 619,
    OF_LIST_TABLE_FEATURE_PROP = 620,
    OF_LIST_TABLE_FEATURES = 621,
    OF_LIST_TABLE_STATS_ENTRY = 622,
    OF_LIST_UINT32 = 623,
    OF_LIST_UINT64 = 624,
    OF_LIST_UINT8 = 625,
...
#define OF_MESSAGE_OBJECT_COUNT 215

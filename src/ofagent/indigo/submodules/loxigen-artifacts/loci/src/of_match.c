...
populate_oxm_list(of_match_t *src, of_list_oxm_t *oxm_list)
{
    ...
    if (OF_MATCH_MASK_OFDPA_BFD_DISCRIMINATOR_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_OFDPA_BFD_DISCRIMINATOR_EXACT_TEST(src)) {
            of_oxm_ofdpa_bfd_discriminator_masked_t *elt;
            elt = &oxm_entry.ofdpa_bfd_discriminator_masked;

            of_oxm_ofdpa_bfd_discriminator_masked_init(elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &oxm_entry);
            of_oxm_ofdpa_bfd_discriminator_masked_value_set(elt,
                   src->fields.ofdpa_bfd_discriminator);
            of_oxm_ofdpa_bfd_discriminator_masked_value_mask_set(elt,
                   src->masks.ofdpa_bfd_discriminator);
        } else {  /* Active, but not masked */
            of_oxm_ofdpa_bfd_discriminator_t *elt;
            elt = &oxm_entry.ofdpa_bfd_discriminator;
            of_oxm_ofdpa_bfd_discriminator_init(elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &oxm_entry);
            of_oxm_ofdpa_bfd_discriminator_value_set(elt, src->fields.ofdpa_bfd_discriminator);
        }
    }
...
of_match_v3_to_match(of_match_v3_t *src, of_match_t *dst)
{
    ...
    while (rv == OF_ERROR_NONE) {
        ...
        case OF_OXM_OFDPA_BFD_DISCRIMINATOR_MASKED:
            of_oxm_ofdpa_bfd_discriminator_masked_value_mask_get(
                &oxm_entry.ofdpa_bfd_discriminator_masked,
                &dst->masks.ofdpa_bfd_discriminator);
            of_oxm_ofdpa_bfd_discriminator_masked_value_get(
                &oxm_entry.ofdpa_bfd_discriminator,
                &dst->fields.ofdpa_bfd_discriminator);
            break;
        case OF_OXM_OFDPA_BFD_DISCRIMINATOR:
            OF_MATCH_MASK_OFDPA_BFD_DISCRIMINATOR_EXACT_SET(dst);

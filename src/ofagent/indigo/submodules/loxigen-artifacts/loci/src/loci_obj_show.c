...
int
ofdpa_class_based_ctr_mod_msg_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_class_based_ctr_mod_msg_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint64_t val64;
    ...
    ofdpa_class_based_ctr_mod_msg_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_class_based_ctr_mod_msg_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_class_based_ctr_mod_msg_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_class_based_ctr_mod_msg_mod_command_get(obj, &val32);
    out += writer(cookie, "mod_command=");
    out += LOCI_SHOW_u32_mod_command(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_class_based_ctr_mod_msg_block_index_get(obj, &val32);
    out += writer(cookie, "block_index=");
    out += LOCI_SHOW_u32_block_index(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_class_based_ctr_mod_msg_transmit_packets_get(obj, &val64);
    out += writer(cookie, "transmit_packets=");
    out += LOCI_SHOW_u64_transmit_packets(writer, cookie, val64);
    out += writer(cookie, " ");

    ofdpa_class_based_ctr_mod_msg_receive_packets_get(obj, &val64);
    out += writer(cookie, "receive_packets=");
    out += LOCI_SHOW_u64_receive_packets(writer, cookie, val64);
    out += writer(cookie, " ");

    ofdpa_class_based_ctr_mod_msg_traffic_class_get(obj, &val8);
...
int
ofdpa_class_based_ctr_multipart_reply_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_class_based_ctr_multipart_reply_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint64_t val64;
    ...
    ofdpa_class_based_ctr_multipart_reply_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_class_based_ctr_multipart_reply_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_class_based_ctr_multipart_reply_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_class_based_ctr_multipart_reply_block_index_get(obj, &val32);
    out += writer(cookie, "block_index=");
    out += LOCI_SHOW_u32_block_index(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_class_based_ctr_multipart_reply_transmit_packets_get(obj, &val64);
    out += writer(cookie, "transmit_packets=");
    out += LOCI_SHOW_u64_transmit_packets(writer, cookie, val64);
    out += writer(cookie, " ");

    ofdpa_class_based_ctr_multipart_reply_receive_packets_get(obj, &val64);
    out += writer(cookie, "receive_packets=");
    out += LOCI_SHOW_u64_receive_packets(writer, cookie, val64);
    out += writer(cookie, " ");

    ofdpa_class_based_ctr_multipart_reply_reference_count_get(obj, &val64);
    out += writer(cookie, "reference_count=");
    out += LOCI_SHOW_u64_reference_count(writer, cookie, val64);
    out += writer(cookie, " ");

    ofdpa_class_based_ctr_multipart_reply_traffic_class_get(obj, &val8);
    out += writer(cookie, "traffic_class=");
    out += LOCI_SHOW_u8_traffic_class(writer, cookie, val8);
    out += writer(cookie, " ");
...
int
ofdpa_class_based_ctr_multipart_request_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_class_based_ctr_multipart_request_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint8_t val8;

    ofdpa_class_based_ctr_multipart_request_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_class_based_ctr_multipart_request_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_class_based_ctr_multipart_request_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_class_based_ctr_multipart_request_block_index_get(obj, &val32);
    out += writer(cookie, "block_index=");
    out += LOCI_SHOW_u32_block_index(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_class_based_ctr_multipart_request_traffic_class_get(obj, &val8);
    out += writer(cookie, "traffic_class=");
    out += LOCI_SHOW_u8_traffic_class(writer, cookie, val8);
    out += writer(cookie, " ");
...
int
ofdpa_color_based_ctr_mod_msg_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_color_based_ctr_mod_msg_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint64_t val64;
    ...
    ofdpa_color_based_ctr_mod_msg_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_color_based_ctr_mod_msg_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_color_based_ctr_mod_msg_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_color_based_ctr_mod_msg_mod_command_get(obj, &val32);
    out += writer(cookie, "mod_command=");
    out += LOCI_SHOW_u32_mod_command(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_color_based_ctr_mod_msg_block_index_get(obj, &val32);
    out += writer(cookie, "block_index=");
    out += LOCI_SHOW_u32_block_index(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_color_based_ctr_mod_msg_transmit_packets_get(obj, &val64);
    out += writer(cookie, "transmit_packets=");
    out += LOCI_SHOW_u64_transmit_packets(writer, cookie, val64);
    out += writer(cookie, " ");

    ofdpa_color_based_ctr_mod_msg_receive_packets_get(obj, &val64);
    out += writer(cookie, "receive_packets=");
    out += LOCI_SHOW_u64_receive_packets(writer, cookie, val64);
    out += writer(cookie, " ");

    ofdpa_color_based_ctr_mod_msg_color_get(obj, &val8);
...
int
ofdpa_color_based_ctr_multipart_reply_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_color_based_ctr_multipart_reply_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint64_t val64;
    ...
    ofdpa_color_based_ctr_multipart_reply_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_color_based_ctr_multipart_reply_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_color_based_ctr_multipart_reply_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_color_based_ctr_multipart_reply_block_index_get(obj, &val32);
    out += writer(cookie, "block_index=");
    out += LOCI_SHOW_u32_block_index(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_color_based_ctr_multipart_reply_transmit_packets_get(obj, &val64);
    out += writer(cookie, "transmit_packets=");
    out += LOCI_SHOW_u64_transmit_packets(writer, cookie, val64);
    out += writer(cookie, " ");

    ofdpa_color_based_ctr_multipart_reply_receive_packets_get(obj, &val64);
    out += writer(cookie, "receive_packets=");
    out += LOCI_SHOW_u64_receive_packets(writer, cookie, val64);
    out += writer(cookie, " ");

    ofdpa_color_based_ctr_multipart_reply_color_get(obj, &val8);
    out += writer(cookie, "color=");
    out += LOCI_SHOW_u8_color(writer, cookie, val8);
    out += writer(cookie, " ");
...
int
ofdpa_color_based_ctr_multipart_request_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_color_based_ctr_multipart_request_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint64_t val64;
    ...
    ofdpa_color_based_ctr_multipart_request_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_color_based_ctr_multipart_request_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_color_based_ctr_multipart_request_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_color_based_ctr_multipart_request_block_index_get(obj, &val32);
    out += writer(cookie, "block_index=");
    out += LOCI_SHOW_u32_block_index(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_color_based_ctr_multipart_request_transmit_packets_get(obj, &val64);
    out += writer(cookie, "transmit_packets=");
    out += LOCI_SHOW_u64_transmit_packets(writer, cookie, val64);
    out += writer(cookie, " ");

    ofdpa_color_based_ctr_multipart_request_receive_packets_get(obj, &val64);
    out += writer(cookie, "receive_packets=");
    out += LOCI_SHOW_u64_receive_packets(writer, cookie, val64);
    out += writer(cookie, " ");

    ofdpa_color_based_ctr_multipart_request_color_get(obj, &val8);
    out += writer(cookie, "color=");
    out += LOCI_SHOW_u8_color(writer, cookie, val8);
    out += writer(cookie, " ");
...
int
ofdpa_l2_interface_remark_action_mod_msg_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_l2_interface_remark_action_mod_msg_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint8_t val8;

    ofdpa_l2_interface_remark_action_mod_msg_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_l2_interface_remark_action_mod_msg_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_l2_interface_remark_action_mod_msg_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_l2_interface_remark_action_mod_msg_mod_command_get(obj, &val32);
    out += writer(cookie, "mod_command=");
    out += LOCI_SHOW_u32_mod_command(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_l2_interface_remark_action_mod_msg_index_get(obj, &val32);
    out += writer(cookie, "index=");
    out += LOCI_SHOW_u32_index(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_l2_interface_remark_action_mod_msg_traffic_class_get(obj, &val8);
    out += writer(cookie, "traffic_class=");
    out += LOCI_SHOW_u8_traffic_class(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_l2_interface_remark_action_mod_msg_color_get(obj, &val8);
    out += writer(cookie, "color=");
    out += LOCI_SHOW_u8_color(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_l2_interface_remark_action_mod_msg_dscp_get(obj, &val8);
    out += writer(cookie, "dscp=");
    out += LOCI_SHOW_u8_dscp(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_l2_interface_remark_action_mod_msg_vlan_pcp_get(obj, &val8);
    out += writer(cookie, "vlan_pcp=");
    out += LOCI_SHOW_u8_vlan_pcp(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_l2_interface_remark_action_mod_msg_vlan_dei_get(obj, &val8);
...
int
ofdpa_l2_interface_remark_action_multipart_reply_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_l2_interface_remark_action_multipart_reply_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;
    ...
    ofdpa_l2_interface_remark_action_multipart_reply_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_l2_interface_remark_action_multipart_reply_flags_get(obj, &val16);
    out += writer(cookie, "flags=");
    out += LOCI_SHOW_u16_flags(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_l2_interface_remark_action_multipart_reply_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_l2_interface_remark_action_multipart_reply_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_l2_interface_remark_action_multipart_reply_index_get(obj, &val32);
    out += writer(cookie, "index=");
    out += LOCI_SHOW_u32_index(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_l2_interface_remark_action_multipart_reply_traffic_class_get(obj, &val8);
    out += writer(cookie, "traffic_class=");
    out += LOCI_SHOW_u8_traffic_class(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_l2_interface_remark_action_multipart_reply_color_get(obj, &val8);
    out += writer(cookie, "color=");
    out += LOCI_SHOW_u8_color(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_l2_interface_remark_action_multipart_reply_mpls_tc_get(obj, &val8);
    out += writer(cookie, "mpls_tc=");
    out += LOCI_SHOW_u8_mpls_tc(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_l2_interface_remark_action_multipart_reply_vlan_pcp_get(obj, &val8);
    out += writer(cookie, "vlan_pcp=");
    out += LOCI_SHOW_u8_vlan_pcp(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_l2_interface_remark_action_multipart_reply_vlan_dei_get(obj, &val8);
    out += writer(cookie, "vlan_dei=");
    out += LOCI_SHOW_u8_vlan_dei(writer, cookie, val8);
    out += writer(cookie, " ");
...
int
ofdpa_l2_interface_remark_action_multipart_request_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_l2_interface_remark_action_multipart_request_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;
    ...
    ofdpa_l2_interface_remark_action_multipart_request_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_l2_interface_remark_action_multipart_request_flags_get(obj, &val16);
    out += writer(cookie, "flags=");
    out += LOCI_SHOW_u16_flags(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_l2_interface_remark_action_multipart_request_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_l2_interface_remark_action_multipart_request_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_l2_interface_remark_action_multipart_request_index_get(obj, &val32);
    out += writer(cookie, "index=");
    out += LOCI_SHOW_u32_index(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_l2_interface_remark_action_multipart_request_traffic_class_get(obj, &val8);
    out += writer(cookie, "traffic_class=");
    out += LOCI_SHOW_u8_traffic_class(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_l2_interface_remark_action_multipart_request_color_get(obj, &val8);
    out += writer(cookie, "color=");
    out += LOCI_SHOW_u8_color(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_l2_interface_remark_action_multipart_request_mpls_tc_get(obj, &val8);
    out += writer(cookie, "mpls_tc=");
    out += LOCI_SHOW_u8_mpls_tc(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_l2_interface_remark_action_multipart_request_vlan_pcp_get(obj, &val8);
    out += writer(cookie, "vlan_pcp=");
    out += LOCI_SHOW_u8_vlan_pcp(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_l2_interface_remark_action_multipart_request_vlan_dei_get(obj, &val8);
    out += writer(cookie, "vlan_dei=");
    out += LOCI_SHOW_u8_vlan_dei(writer, cookie, val8);
    out += writer(cookie, " ");
...
int
ofdpa_mpls_set_qos_action_mod_msg_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_mpls_set_qos_action_mod_msg_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint8_t val8;

    ofdpa_mpls_set_qos_action_mod_msg_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_set_qos_action_mod_msg_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_set_qos_action_mod_msg_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_set_qos_action_mod_msg_mod_command_get(obj, &val32);
    out += writer(cookie, "mod_command=");
    out += LOCI_SHOW_u32_mod_command(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_set_qos_action_mod_msg_qos_index_get(obj, &val8);
    out += writer(cookie, "qos_index=");
    out += LOCI_SHOW_u8_qos_index(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_set_qos_action_mod_msg_mpls_tc_get(obj, &val8);
    out += writer(cookie, "mpls_tc=");
    out += LOCI_SHOW_u8_mpls_tc(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_set_qos_action_mod_msg_traffic_class_get(obj, &val8);
    out += writer(cookie, "traffic_class=");
    out += LOCI_SHOW_u8_traffic_class(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_set_qos_action_mod_msg_color_get(obj, &val8);
    out += writer(cookie, "color=");
    out += LOCI_SHOW_u8_color(writer, cookie, val8);
    out += writer(cookie, " ");
...
int
ofdpa_mpls_set_qos_action_multipart_reply_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_mpls_set_qos_action_multipart_reply_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;
    ...
    ofdpa_mpls_set_qos_action_multipart_reply_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_set_qos_action_multipart_reply_flags_get(obj, &val16);
    out += writer(cookie, "flags=");
    out += LOCI_SHOW_u16_flags(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_mpls_set_qos_action_multipart_reply_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_set_qos_action_multipart_reply_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_set_qos_action_multipart_reply_qos_index_get(obj, &val8);
    out += writer(cookie, "qos_index=");
    out += LOCI_SHOW_u8_qos_index(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_set_qos_action_multipart_reply_mpls_tc_get(obj, &val8);
    out += writer(cookie, "mpls_tc=");
    out += LOCI_SHOW_u8_mpls_tc(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_set_qos_action_multipart_reply_traffic_class_get(obj, &val8);
    out += writer(cookie, "traffic_class=");
    out += LOCI_SHOW_u8_traffic_class(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_set_qos_action_multipart_reply_color_get(obj, &val8);
    out += writer(cookie, "color=");
    out += LOCI_SHOW_u8_color(writer, cookie, val8);
    out += writer(cookie, " ");
...
int
ofdpa_mpls_set_qos_action_multipart_request_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_mpls_set_qos_action_multipart_request_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;
    ...
    ofdpa_mpls_set_qos_action_multipart_request_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_set_qos_action_multipart_request_flags_get(obj, &val16);
    out += writer(cookie, "flags=");
    out += LOCI_SHOW_u16_flags(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_mpls_set_qos_action_multipart_request_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_set_qos_action_multipart_request_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_set_qos_action_multipart_request_qos_index_get(obj, &val8);
    out += writer(cookie, "qos_index=");
    out += LOCI_SHOW_u8_qos_index(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_set_qos_action_multipart_request_mpls_tc_get(obj, &val8);
    out += writer(cookie, "mpls_tc=");
    out += LOCI_SHOW_u8_mpls_tc(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_set_qos_action_multipart_request_traffic_class_get(obj, &val8);
    out += writer(cookie, "traffic_class=");
    out += LOCI_SHOW_u8_traffic_class(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_set_qos_action_multipart_request_color_get(obj, &val8);
    out += writer(cookie, "color=");
    out += LOCI_SHOW_u8_color(writer, cookie, val8);
    out += writer(cookie, " ");
...
int
ofdpa_mpls_tunnel_label_multipart_reply_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_mpls_tunnel_label_multipart_reply_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;
    ...
    ofdpa_mpls_tunnel_label_multipart_reply_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_tunnel_label_multipart_reply_flags_get(obj, &val16);
    out += writer(cookie, "flags=");
    out += LOCI_SHOW_u16_flags(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_mpls_tunnel_label_multipart_reply_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_tunnel_label_multipart_reply_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_tunnel_label_multipart_reply_index_get(obj, &val32);
    out += writer(cookie, "index=");
    out += LOCI_SHOW_u32_index(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_tunnel_label_multipart_reply_traffic_class_get(obj, &val8);
    out += writer(cookie, "traffic_class=");
    out += LOCI_SHOW_u8_traffic_class(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_tunnel_label_multipart_reply_color_get(obj, &val8);
    out += writer(cookie, "color=");
    out += LOCI_SHOW_u8_color(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_tunnel_label_multipart_reply_mpls_tc_get(obj, &val8);
    out += writer(cookie, "mpls_tc=");
    out += LOCI_SHOW_u8_mpls_tc(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_tunnel_label_multipart_reply_vlan_pcp_get(obj, &val8);
    out += writer(cookie, "vlan_pcp=");
    out += LOCI_SHOW_u8_vlan_pcp(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_tunnel_label_multipart_reply_vlan_dei_get(obj, &val8);
    out += writer(cookie, "vlan_dei=");
    out += LOCI_SHOW_u8_vlan_dei(writer, cookie, val8);
    out += writer(cookie, " ");
...
int
ofdpa_mpls_tunnel_label_multipart_request_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_mpls_tunnel_label_multipart_request_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;
    ...
    ofdpa_mpls_tunnel_label_multipart_request_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_tunnel_label_multipart_request_flags_get(obj, &val16);
    out += writer(cookie, "flags=");
    out += LOCI_SHOW_u16_flags(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_mpls_tunnel_label_multipart_request_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_tunnel_label_multipart_request_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_tunnel_label_multipart_request_index_get(obj, &val32);
    out += writer(cookie, "index=");
    out += LOCI_SHOW_u32_index(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_tunnel_label_multipart_request_traffic_class_get(obj, &val8);
    out += writer(cookie, "traffic_class=");
    out += LOCI_SHOW_u8_traffic_class(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_tunnel_label_multipart_request_color_get(obj, &val8);
    out += writer(cookie, "color=");
    out += LOCI_SHOW_u8_color(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_tunnel_label_multipart_request_mpls_tc_get(obj, &val8);
    out += writer(cookie, "mpls_tc=");
    out += LOCI_SHOW_u8_mpls_tc(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_tunnel_label_multipart_request_vlan_pcp_get(obj, &val8);
    out += writer(cookie, "vlan_pcp=");
    out += LOCI_SHOW_u8_vlan_pcp(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_tunnel_label_multipart_request_vlan_dei_get(obj, &val8);
    out += writer(cookie, "vlan_dei=");
    out += LOCI_SHOW_u8_vlan_dei(writer, cookie, val8);
    out += writer(cookie, " ");
...
int
ofdpa_mpls_tunnel_label_remark_action_mod_msg_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_mpls_tunnel_label_remark_action_mod_msg_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint8_t val8;

    ofdpa_mpls_tunnel_label_remark_action_mod_msg_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_tunnel_label_remark_action_mod_msg_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_tunnel_label_remark_action_mod_msg_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_tunnel_label_remark_action_mod_msg_mod_command_get(obj, &val32);
    out += writer(cookie, "mod_command=");
    out += LOCI_SHOW_u32_mod_command(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_tunnel_label_remark_action_mod_msg_index_get(obj, &val32);
    out += writer(cookie, "index=");
    out += LOCI_SHOW_u32_index(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_tunnel_label_remark_action_mod_msg_traffic_class_get(obj, &val8);
    out += writer(cookie, "traffic_class=");
    out += LOCI_SHOW_u8_traffic_class(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_tunnel_label_remark_action_mod_msg_color_get(obj, &val8);
    out += writer(cookie, "color=");
    out += LOCI_SHOW_u8_color(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_tunnel_label_remark_action_mod_msg_mpls_tc_get(obj, &val8);
    out += writer(cookie, "mpls_tc=");
    out += LOCI_SHOW_u8_mpls_tc(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_tunnel_label_remark_action_mod_msg_vlan_pcp_get(obj, &val8);
    out += writer(cookie, "vlan_pcp=");
    out += LOCI_SHOW_u8_vlan_pcp(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_tunnel_label_remark_action_mod_msg_vlan_dei_get(obj, &val8);
    out += writer(cookie, "vlan_dei=");
    out += LOCI_SHOW_u8_vlan_dei(writer, cookie, val8);
    out += writer(cookie, " ");
...
int
ofdpa_mpls_vpn_label_remark_action_mod_msg_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_mpls_vpn_label_remark_action_mod_msg_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint8_t val8;

    ofdpa_mpls_vpn_label_remark_action_mod_msg_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_vpn_label_remark_action_mod_msg_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_vpn_label_remark_action_mod_msg_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_vpn_label_remark_action_mod_msg_mod_command_get(obj, &val32);
    out += writer(cookie, "mod_command=");
    out += LOCI_SHOW_u32_mod_command(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_vpn_label_remark_action_mod_msg_index_get(obj, &val32);
    out += writer(cookie, "index=");
    out += LOCI_SHOW_u32_index(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_vpn_label_remark_action_mod_msg_traffic_class_get(obj, &val8);
    out += writer(cookie, "traffic_class=");
    out += LOCI_SHOW_u8_traffic_class(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_vpn_label_remark_action_mod_msg_color_get(obj, &val8);
    out += writer(cookie, "color=");
    out += LOCI_SHOW_u8_color(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_vpn_label_remark_action_mod_msg_mpls_tc_get(obj, &val8);
    out += writer(cookie, "mpls_tc=");
    out += LOCI_SHOW_u8_mpls_tc(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_vpn_label_remark_action_mod_msg_vlan_pcp_get(obj, &val8);
    out += writer(cookie, "vlan_pcp=");
    out += LOCI_SHOW_u8_vlan_pcp(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_vpn_label_remark_action_mod_msg_vlan_dei_get(obj, &val8);
    out += writer(cookie, "vlan_dei=");
    out += LOCI_SHOW_u8_vlan_dei(writer, cookie, val8);
    out += writer(cookie, " ");
...
int
ofdpa_mpls_vpn_label_remark_action_multipart_reply_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_mpls_vpn_label_remark_action_multipart_reply_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;
    ...
    ofdpa_mpls_vpn_label_remark_action_multipart_reply_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_vpn_label_remark_action_multipart_reply_flags_get(obj, &val16);
    out += writer(cookie, "flags=");
    out += LOCI_SHOW_u16_flags(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_mpls_vpn_label_remark_action_multipart_reply_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_vpn_label_remark_action_multipart_reply_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_vpn_label_remark_action_multipart_reply_index_get(obj, &val32);
    out += writer(cookie, "index=");
    out += LOCI_SHOW_u32_index(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_vpn_label_remark_action_multipart_reply_traffic_class_get(obj, &val8);
    out += writer(cookie, "traffic_class=");
    out += LOCI_SHOW_u8_traffic_class(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_vpn_label_remark_action_multipart_reply_color_get(obj, &val8);
    out += writer(cookie, "color=");
    out += LOCI_SHOW_u8_color(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_vpn_label_remark_action_multipart_reply_mpls_tc_get(obj, &val8);
    out += writer(cookie, "mpls_tc=");
    out += LOCI_SHOW_u8_mpls_tc(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_vpn_label_remark_action_multipart_reply_vlan_pcp_get(obj, &val8);
    out += writer(cookie, "vlan_pcp=");
    out += LOCI_SHOW_u8_vlan_pcp(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_vpn_label_remark_action_multipart_reply_vlan_dei_get(obj, &val8);
    out += writer(cookie, "vlan_dei=");
    out += LOCI_SHOW_u8_vlan_dei(writer, cookie, val8);
    out += writer(cookie, " ");
...
int
ofdpa_mpls_vpn_label_remark_action_multipart_request_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_mpls_vpn_label_remark_action_multipart_request_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;
    ...
    ofdpa_mpls_vpn_label_remark_action_multipart_request_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_vpn_label_remark_action_multipart_request_flags_get(obj, &val16);
    out += writer(cookie, "flags=");
    out += LOCI_SHOW_u16_flags(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_mpls_vpn_label_remark_action_multipart_request_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_vpn_label_remark_action_multipart_request_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_vpn_label_remark_action_multipart_request_index_get(obj, &val32);
    out += writer(cookie, "index=");
    out += LOCI_SHOW_u32_index(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_mpls_vpn_label_remark_action_multipart_request_traffic_class_get(obj, &val8);
    out += writer(cookie, "traffic_class=");
    out += LOCI_SHOW_u8_traffic_class(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_vpn_label_remark_action_multipart_request_color_get(obj, &val8);
    out += writer(cookie, "color=");
    out += LOCI_SHOW_u8_color(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_vpn_label_remark_action_multipart_request_mpls_tc_get(obj, &val8);
    out += writer(cookie, "mpls_tc=");
    out += LOCI_SHOW_u8_mpls_tc(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_vpn_label_remark_action_multipart_request_vlan_pcp_get(obj, &val8);
    out += writer(cookie, "vlan_pcp=");
    out += LOCI_SHOW_u8_vlan_pcp(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_mpls_vpn_label_remark_action_multipart_request_vlan_dei_get(obj, &val8);
    out += writer(cookie, "vlan_dei=");
    out += LOCI_SHOW_u8_vlan_dei(writer, cookie, val8);
    out += writer(cookie, " ");
...
int
ofdpa_oam_dataplane_ctr_mod_msg_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_oam_dataplane_ctr_mod_msg_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint64_t val64;
    ...
    ofdpa_oam_dataplane_ctr_mod_msg_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_oam_dataplane_ctr_mod_msg_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_oam_dataplane_ctr_mod_msg_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_oam_dataplane_ctr_mod_msg_mod_command_get(obj, &val32);
    out += writer(cookie, "mod_command=");
    out += LOCI_SHOW_u32_mod_command(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_oam_dataplane_ctr_mod_msg_lmep_id_get(obj, &val32);
    out += writer(cookie, "lmep_id=");
    out += LOCI_SHOW_u32_lmep_id(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_oam_dataplane_ctr_mod_msg_transmit_packets_get(obj, &val64);
    out += writer(cookie, "transmit_packets=");
    out += LOCI_SHOW_u64_transmit_packets(writer, cookie, val64);
    out += writer(cookie, " ");

    ofdpa_oam_dataplane_ctr_mod_msg_receive_packets_get(obj, &val64);
    out += writer(cookie, "receive_packets=");
    out += LOCI_SHOW_u64_receive_packets(writer, cookie, val64);
    out += writer(cookie, " ");

    ofdpa_oam_dataplane_ctr_mod_msg_traffic_class_get(obj, &val8);
    out += writer(cookie, "traffic_class=");
    out += LOCI_SHOW_u8_traffic_class(writer, cookie, val8);
    out += writer(cookie, " ");
...
int
ofdpa_oam_dataplane_ctr_multipart_reply_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_oam_dataplane_ctr_multipart_reply_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;
    ...
    ofdpa_oam_dataplane_ctr_multipart_reply_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_oam_dataplane_ctr_multipart_reply_flags_get(obj, &val16);
    out += writer(cookie, "flags=");
    out += LOCI_SHOW_u16_flags(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_oam_dataplane_ctr_multipart_reply_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_oam_dataplane_ctr_multipart_reply_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_oam_dataplane_ctr_multipart_reply_lmep_id_get(obj, &val32);
    out += writer(cookie, "lmep_id=");
    out += LOCI_SHOW_u32_lmep_id(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_oam_dataplane_ctr_multipart_reply_receive_packets_get(obj, &val64);
    out += writer(cookie, "receive_packets=");
    out += LOCI_SHOW_u64_receive_packets(writer, cookie, val64);
    out += writer(cookie, " ");

    ofdpa_oam_dataplane_ctr_multipart_reply_transmit_packets_get(obj, &val64);
    out += writer(cookie, "transmit_packets=");
    out += LOCI_SHOW_u64_transmit_packets(writer, cookie, val64);
    out += writer(cookie, " ");

    ofdpa_oam_dataplane_ctr_multipart_reply_reference_count_get(obj, &val64);
    out += writer(cookie, "reference_count=");
    out += LOCI_SHOW_u64_reference_count(writer, cookie, val64);
    out += writer(cookie, " ");

    ofdpa_oam_dataplane_ctr_multipart_reply_traffic_class_get(obj, &val8);
    out += writer(cookie, "traffic_class=");
    out += LOCI_SHOW_u8_traffic_class(writer, cookie, val8);
    out += writer(cookie, " ");
...
int
ofdpa_oam_dataplane_ctr_multipart_request_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_oam_dataplane_ctr_multipart_request_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;
    ...
    ofdpa_oam_dataplane_ctr_multipart_request_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_oam_dataplane_ctr_multipart_request_flags_get(obj, &val16);
    out += writer(cookie, "flags=");
    out += LOCI_SHOW_u16_flags(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_oam_dataplane_ctr_multipart_request_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_oam_dataplane_ctr_multipart_request_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_oam_dataplane_ctr_multipart_request_lmep_id_get(obj, &val32);
    out += writer(cookie, "lmep_id=");
    out += LOCI_SHOW_u32_lmep_id(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_oam_dataplane_ctr_multipart_request_transmit_packets_get(obj, &val64);
    out += writer(cookie, "transmit_packets=");
    out += LOCI_SHOW_u64_transmit_packets(writer, cookie, val64);
    out += writer(cookie, " ");

    ofdpa_oam_dataplane_ctr_multipart_request_receive_packets_get(obj, &val64);
    out += writer(cookie, "receive_packets=");
    out += LOCI_SHOW_u64_receive_packets(writer, cookie, val64);
    out += writer(cookie, " ");

    ofdpa_oam_dataplane_ctr_multipart_request_reference_count_get(obj, &val64);
    out += writer(cookie, "reference_count=");
    out += LOCI_SHOW_u64_reference_count(writer, cookie, val64);
    out += writer(cookie, " ");

    ofdpa_oam_dataplane_ctr_multipart_request_traffic_class_get(obj, &val8);
    out += writer(cookie, "traffic_class=");
    out += LOCI_SHOW_u8_traffic_class(writer, cookie, val8);
    out += writer(cookie, " ");
...
int
ofdpa_oam_drop_status_mod_msg_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_oam_drop_status_mod_msg_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint8_t val8;

    ofdpa_oam_drop_status_mod_msg_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_oam_drop_status_mod_msg_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_oam_drop_status_mod_msg_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_oam_drop_status_mod_msg_mod_command_get(obj, &val32);
    out += writer(cookie, "mod_command=");
    out += LOCI_SHOW_u32_mod_command(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_oam_drop_status_mod_msg_index_get(obj, &val32);
    out += writer(cookie, "index=");
    out += LOCI_SHOW_u32_index(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_oam_drop_status_mod_msg_entry_type_get(obj, &val8);
    out += writer(cookie, "entry_type=");
    out += LOCI_SHOW_u8_entry_type(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_oam_drop_status_mod_msg_drop_status_get(obj, &val8);
...
int
ofdpa_oam_drop_status_multipart_reply_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_oam_drop_status_multipart_reply_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;
    ...
    ofdpa_oam_drop_status_multipart_reply_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_oam_drop_status_multipart_reply_flags_get(obj, &val16);
    out += writer(cookie, "flags=");
    out += LOCI_SHOW_u16_flags(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_oam_drop_status_multipart_reply_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_oam_drop_status_multipart_reply_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_oam_drop_status_multipart_reply_index_get(obj, &val32);
    out += writer(cookie, "index=");
    out += LOCI_SHOW_u32_index(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_oam_drop_status_multipart_reply_entry_type_get(obj, &val8);
    out += writer(cookie, "entry_type=");
    out += LOCI_SHOW_u8_entry_type(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_oam_drop_status_multipart_reply_drop_status_get(obj, &val8);
    out += writer(cookie, "drop_status=");
    out += LOCI_SHOW_u8_drop_status(writer, cookie, val8);
    out += writer(cookie, " ");
...
int
ofdpa_oam_drop_status_multipart_request_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_oam_drop_status_multipart_request_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;
    ...
    ofdpa_oam_drop_status_multipart_request_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_oam_drop_status_multipart_request_flags_get(obj, &val16);
    out += writer(cookie, "flags=");
    out += LOCI_SHOW_u16_flags(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_oam_drop_status_multipart_request_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_oam_drop_status_multipart_request_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_oam_drop_status_multipart_request_mod_command_get(obj, &val32);
    out += writer(cookie, "mod_command=");
    out += LOCI_SHOW_u32_mod_command(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_oam_drop_status_multipart_request_index_get(obj, &val32);
    out += writer(cookie, "index=");
    out += LOCI_SHOW_u32_index(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_oam_drop_status_multipart_request_entry_type_get(obj, &val8);
    out += writer(cookie, "entry_type=");
    out += LOCI_SHOW_u8_entry_type(writer, cookie, val8);
    out += writer(cookie, " ");

    ofdpa_oam_drop_status_multipart_request_drop_status_get(obj, &val8);
    out += writer(cookie, "drop_status=");
    out += LOCI_SHOW_u8_drop_status(writer, cookie, val8);
    out += writer(cookie, " ");
...
int
ofdpa_port_experimenter_prop_scheduling_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_port_experimenter_prop_scheduling_t *obj)
{
    int out = 0;
    uint32_t val32;
    of_mac_addr_t mac_addr;
    ...
    ofdpa_port_experimenter_prop_scheduling_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_port_experimenter_prop_scheduling_port_no_get(obj, &val32);
    out += writer(cookie, "port_no=");
    out += LOCI_SHOW_u32_port_no(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_port_experimenter_prop_scheduling_hw_addr_get(obj, &mac_addr);
    out += writer(cookie, "hw_addr=");
    out += LOCI_SHOW_mac_hw_addr(writer, cookie, mac_addr);
    out += writer(cookie, " ");

    ofdpa_port_experimenter_prop_scheduling_config_get(obj, &val32);
    out += writer(cookie, "config=");
    out += LOCI_SHOW_u32_config(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_port_experimenter_prop_scheduling_mask_get(obj, &val32);
    out += writer(cookie, "mask=");
    out += LOCI_SHOW_u32_mask(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_port_experimenter_prop_scheduling_pm_type_get(obj, &val16);
    out += writer(cookie, "pm_type=");
    out += LOCI_SHOW_u16_pm_type(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_port_experimenter_prop_scheduling_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_port_experimenter_prop_scheduling_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_port_experimenter_prop_scheduling_mode_get(obj, &val16);
    out += writer(cookie, "mode=");
    out += LOCI_SHOW_u16_mode(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_port_experimenter_prop_scheduling_parameter_get(obj, &val16);
...
int
ofdpa_queue_desc_prop_congestion_multipart_reply_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_queue_desc_prop_congestion_multipart_reply_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;

    ofdpa_queue_desc_prop_congestion_multipart_reply_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_queue_desc_prop_congestion_multipart_reply_flags_get(obj, &val16);
    out += writer(cookie, "flags=");
    out += LOCI_SHOW_u16_flags(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_queue_desc_prop_congestion_multipart_reply_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_queue_desc_prop_congestion_multipart_reply_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_queue_desc_prop_congestion_multipart_reply_mode_get(obj, &val16);
    out += writer(cookie, "mode=");
    out += LOCI_SHOW_u16_mode(writer, cookie, val16);
    out += writer(cookie, " ");
...
int
ofdpa_queue_desc_prop_congestion_multipart_request_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_queue_desc_prop_congestion_multipart_request_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;

    ofdpa_queue_desc_prop_congestion_multipart_request_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_queue_desc_prop_congestion_multipart_request_flags_get(obj, &val16);
    out += writer(cookie, "flags=");
    out += LOCI_SHOW_u16_flags(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_queue_desc_prop_congestion_multipart_request_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_queue_desc_prop_congestion_multipart_request_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_queue_desc_prop_congestion_multipart_request_mode_get(obj, &val16);
    out += writer(cookie, "mode=");
    out += LOCI_SHOW_u16_mode(writer, cookie, val16);
    out += writer(cookie, " ");
...
int
ofdpa_queue_desc_prop_parent_multipart_reply_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_queue_desc_prop_parent_multipart_reply_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;

    ofdpa_queue_desc_prop_parent_multipart_reply_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_queue_desc_prop_parent_multipart_reply_flags_get(obj, &val16);
    out += writer(cookie, "flags=");
    out += LOCI_SHOW_u16_flags(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_queue_desc_prop_parent_multipart_reply_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_queue_desc_prop_parent_multipart_reply_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_queue_desc_prop_parent_multipart_reply_scheduler_level_get(obj, &val16);
...
int
ofdpa_queue_desc_prop_parent_multipart_request_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_queue_desc_prop_parent_multipart_request_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;

    ofdpa_queue_desc_prop_parent_multipart_request_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_queue_desc_prop_parent_multipart_request_flags_get(obj, &val16);
    out += writer(cookie, "flags=");
    out += LOCI_SHOW_u16_flags(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_queue_desc_prop_parent_multipart_request_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_queue_desc_prop_parent_multipart_request_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_queue_desc_prop_parent_multipart_request_scheduler_level_get(obj, &val16);
    out += writer(cookie, "scheduler_level=");
    out += LOCI_SHOW_u16_scheduler_level(writer, cookie, val16);
    out += writer(cookie, " ");
...
int
ofdpa_queue_mod_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_queue_mod_t *obj)
{
    int out = 0;
    uint32_t val32;

    ofdpa_queue_mod_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_queue_mod_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_queue_mod_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_queue_mod_mod_command_get(obj, &val32);
    out += writer(cookie, "mod_command=");
    out += LOCI_SHOW_u32_mod_command(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_queue_mod_port_no_get(obj, &val32);
    out += writer(cookie, "port_no=");
    out += LOCI_SHOW_u32_port_no(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_queue_mod_queue_id_get(obj, &val32);
    out += writer(cookie, "queue_id=");
    out += LOCI_SHOW_u32_queue_id(writer, cookie, val32);
    out += writer(cookie, " ");
...
int
ofdpa_scheduler_node_mod_msg_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_scheduler_node_mod_msg_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;

    ofdpa_scheduler_node_mod_msg_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_scheduler_node_mod_msg_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_scheduler_node_mod_msg_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_scheduler_node_mod_msg_mod_command_get(obj, &val32);
    out += writer(cookie, "mod_command=");
    out += LOCI_SHOW_u32_mod_command(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_scheduler_node_mod_msg_level_get(obj, &val16);
    out += writer(cookie, "level=");
    out += LOCI_SHOW_u16_level(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_scheduler_node_mod_msg_port_get(obj, &val32);
    out += writer(cookie, "port=");
    out += LOCI_SHOW_u32_port(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_scheduler_node_mod_msg_max_rate_get(obj, &val16);
    out += writer(cookie, "max_rate=");
    out += LOCI_SHOW_u16_max_rate(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_scheduler_node_mod_msg_min_rate_get(obj, &val16);
    out += writer(cookie, "min_rate=");
    out += LOCI_SHOW_u16_min_rate(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_scheduler_node_mod_msg_mode_get(obj, &val16);
    out += writer(cookie, "mode=");
    out += LOCI_SHOW_u16_mode(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_scheduler_node_mod_msg_weight_get(obj, &val16);
    out += writer(cookie, "weight=");
    out += LOCI_SHOW_u16_weight(writer, cookie, val16);
    out += writer(cookie, " ");
...
int
ofdpa_scheduler_node_multipart_request_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_scheduler_node_multipart_request_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;

    ofdpa_scheduler_node_multipart_request_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_scheduler_node_multipart_request_flags_get(obj, &val16);
    out += writer(cookie, "flags=");
    out += LOCI_SHOW_u16_flags(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_scheduler_node_multipart_request_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_scheduler_node_multipart_request_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_scheduler_node_multipart_request_port_get(obj, &val32);
    out += writer(cookie, "port=");
    out += LOCI_SHOW_u32_port(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_scheduler_node_multipart_request_level_get(obj, &val16);
    out += writer(cookie, "level=");
    out += LOCI_SHOW_u16_level(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_scheduler_node_multipart_request_max_rate_get(obj, &val16);
    out += writer(cookie, "max_rate=");
    out += LOCI_SHOW_u16_max_rate(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_scheduler_node_multipart_request_min_rate_get(obj, &val16);
    out += writer(cookie, "min_rate=");
    out += LOCI_SHOW_u16_min_rate(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_scheduler_node_multipart_request_mode_get(obj, &val16);
    out += writer(cookie, "mode=");
    out += LOCI_SHOW_u16_mode(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_scheduler_node_multipart_request_weight_get(obj, &val16);
    out += writer(cookie, "weight=");
    out += LOCI_SHOW_u16_weight(writer, cookie, val16);
    out += writer(cookie, " ");
...
int
ofdpa_scheduler_node_multipart_response_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, ofdpa_scheduler_node_multipart_response_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;

    ofdpa_scheduler_node_multipart_response_xid_get(obj, &val32);
    out += writer(cookie, "xid=");
    out += LOCI_SHOW_u32_xid(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_scheduler_node_multipart_response_flags_get(obj, &val16);
    out += writer(cookie, "flags=");
    out += LOCI_SHOW_u16_flags(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_scheduler_node_multipart_response_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_scheduler_node_multipart_response_subtype_get(obj, &val32);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u32_subtype(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_scheduler_node_multipart_response_port_get(obj, &val32);
    out += writer(cookie, "port=");
    out += LOCI_SHOW_u32_port(writer, cookie, val32);
    out += writer(cookie, " ");

    ofdpa_scheduler_node_multipart_response_level_get(obj, &val16);
    out += writer(cookie, "level=");
    out += LOCI_SHOW_u16_level(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_scheduler_node_multipart_response_max_rate_get(obj, &val16);
    out += writer(cookie, "max_rate=");
    out += LOCI_SHOW_u16_max_rate(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_scheduler_node_multipart_response_min_rate_get(obj, &val16);
    out += writer(cookie, "min_rate=");
    out += LOCI_SHOW_u16_min_rate(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_scheduler_node_multipart_response_mode_get(obj, &val16);
    out += writer(cookie, "mode=");
    out += LOCI_SHOW_u16_mode(writer, cookie, val16);
    out += writer(cookie, " ");

    ofdpa_scheduler_node_multipart_response_weight_get(obj, &val16);
    out += writer(cookie, "weight=");
    out += LOCI_SHOW_u16_weight(writer, cookie, val16);
    out += writer(cookie, " ");
...
int
of_action_id_ofdpa_class_based_rx_count_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, of_action_id_ofdpa_class_based_rx_count_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;

    of_action_id_ofdpa_class_based_rx_count_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    of_action_id_ofdpa_class_based_rx_count_subtype_get(obj, &val16);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u16_subtype(writer, cookie, val16);
    out += writer(cookie, " ");
...
int
of_action_id_ofdpa_class_based_tx_count_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, of_action_id_ofdpa_class_based_tx_count_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;

    of_action_id_ofdpa_class_based_tx_count_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    of_action_id_ofdpa_class_based_tx_count_subtype_get(obj, &val16);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u16_subtype(writer, cookie, val16);
    out += writer(cookie, " ");
...
int
of_action_id_ofdpa_color_based_rx_count_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, of_action_id_ofdpa_color_based_rx_count_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;

    of_action_id_ofdpa_color_based_rx_count_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    of_action_id_ofdpa_color_based_rx_count_subtype_get(obj, &val16);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u16_subtype(writer, cookie, val16);
    out += writer(cookie, " ");
...
int
of_action_id_ofdpa_color_based_tx_count_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, of_action_id_ofdpa_color_based_tx_count_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;

    of_action_id_ofdpa_color_based_tx_count_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    of_action_id_ofdpa_color_based_tx_count_subtype_get(obj, &val16);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u16_subtype(writer, cookie, val16);
    out += writer(cookie, " ");
...
int
of_action_id_ofdpa_set_mpls_qos_from_table_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, of_action_id_ofdpa_set_mpls_qos_from_table_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;

    of_action_id_ofdpa_set_mpls_qos_from_table_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    of_action_id_ofdpa_set_mpls_qos_from_table_subtype_get(obj, &val16);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u16_subtype(writer, cookie, val16);
    out += writer(cookie, " ");
...
int
of_action_ofdpa_class_based_rx_count_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, of_action_ofdpa_class_based_rx_count_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;

    of_action_ofdpa_class_based_rx_count_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    of_action_ofdpa_class_based_rx_count_subtype_get(obj, &val16);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u16_subtype(writer, cookie, val16);
    out += writer(cookie, " ");

    of_action_ofdpa_class_based_rx_count_traffic_class_get(obj, &val16);
    out += writer(cookie, "traffic_class=");
    out += LOCI_SHOW_u16_traffic_class(writer, cookie, val16);
    out += writer(cookie, " ");

    of_action_ofdpa_class_based_rx_count_index_get(obj, &val32);
    out += writer(cookie, "index=");
    out += LOCI_SHOW_u32_index(writer, cookie, val32);
    out += writer(cookie, " ");
...
int
of_action_ofdpa_class_based_tx_count_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, of_action_ofdpa_class_based_tx_count_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;

    of_action_ofdpa_class_based_tx_count_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    of_action_ofdpa_class_based_tx_count_subtype_get(obj, &val16);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u16_subtype(writer, cookie, val16);
    out += writer(cookie, " ");

    of_action_ofdpa_class_based_tx_count_traffic_class_get(obj, &val16);
    out += writer(cookie, "traffic_class=");
    out += LOCI_SHOW_u16_traffic_class(writer, cookie, val16);
    out += writer(cookie, " ");

    of_action_ofdpa_class_based_tx_count_index_get(obj, &val32);
    out += writer(cookie, "index=");
    out += LOCI_SHOW_u32_index(writer, cookie, val32);
    out += writer(cookie, " ");
...
int
of_action_ofdpa_color_based_rx_count_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, of_action_ofdpa_color_based_rx_count_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;

    of_action_ofdpa_color_based_rx_count_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    of_action_ofdpa_color_based_rx_count_subtype_get(obj, &val16);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u16_subtype(writer, cookie, val16);
    out += writer(cookie, " ");

    of_action_ofdpa_color_based_rx_count_act_color_get(obj, &val16);
    out += writer(cookie, "act_color=");
    out += LOCI_SHOW_u16_act_color(writer, cookie, val16);
    out += writer(cookie, " ");

    of_action_ofdpa_color_based_rx_count_index_get(obj, &val32);
    out += writer(cookie, "index=");
    out += LOCI_SHOW_u32_index(writer, cookie, val32);
    out += writer(cookie, " ");
...
int
of_action_ofdpa_color_based_tx_count_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, of_action_ofdpa_color_based_tx_count_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;

    of_action_ofdpa_color_based_tx_count_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    of_action_ofdpa_color_based_tx_count_subtype_get(obj, &val16);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u16_subtype(writer, cookie, val16);
    out += writer(cookie, " ");

    of_action_ofdpa_color_based_tx_count_act_color_get(obj, &val16);
    out += writer(cookie, "act_color=");
    out += LOCI_SHOW_u16_act_color(writer, cookie, val16);
    out += writer(cookie, " ");

    of_action_ofdpa_color_based_tx_count_index_get(obj, &val32);
    out += writer(cookie, "index=");
    out += LOCI_SHOW_u32_index(writer, cookie, val32);
    out += writer(cookie, " ");
...
of_action_ofdpa_oam_lm_rx_count_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, of_action_ofdpa_oam_lm_rx_count_t *obj)
{
    ...
    of_action_ofdpa_oam_lm_rx_count_traffic_class_get(obj, &val16);
    out += writer(cookie, "traffic_class=");
    out += LOCI_SHOW_u16_traffic_class(writer, cookie, val16);
    out += writer(cookie, " ");
...
of_action_ofdpa_oam_lm_tx_count_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, of_action_ofdpa_oam_lm_tx_count_t *obj)
{
    ...
    of_action_ofdpa_oam_lm_tx_count_traffic_class_get(obj, &val16);
    out += writer(cookie, "traffic_class=");
    out += LOCI_SHOW_u16_traffic_class(writer, cookie, val16);
    out += writer(cookie, " ");
...
of_action_ofdpa_set_counter_fields_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, of_action_ofdpa_set_counter_fields_t *obj)
{
    ...
    of_action_ofdpa_set_counter_fields_traffic_class_get(obj, &val16);
    out += writer(cookie, "traffic_class=");
    out += LOCI_SHOW_u16_traffic_class(writer, cookie, val16);
    out += writer(cookie, " ");
...
of_action_ofdpa_set_mpls_pcpdei_from_table_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, of_action_ofdpa_set_mpls_pcpdei_from_table_t *obj)
{
    ...
    of_action_ofdpa_set_mpls_pcpdei_from_table_qos_index_get(obj, &val8);
    out += writer(cookie, "qos_index=");
    out += LOCI_SHOW_u8_qos_index(writer, cookie, val8);
    out += writer(cookie, " ");
    ...
    of_action_ofdpa_set_mpls_pcpdei_from_table_pcp_dei_get(obj, &val8);
    out += writer(cookie, "pcp_dei=");
    out += LOCI_SHOW_u8_pcp_dei(writer, cookie, val8);
    out += writer(cookie, " ");
...
of_action_ofdpa_set_mpls_pcpdei_from_tunnel_table_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, of_action_ofdpa_set_mpls_pcpdei_from_tunnel_table_t *obj)
{
    ...
    of_action_ofdpa_set_mpls_pcpdei_from_tunnel_table_qos_index_get(obj, &val8);
    out += writer(cookie, "qos_index=");
    out += LOCI_SHOW_u8_qos_index(writer, cookie, val8);
    out += writer(cookie, " ");
    ...
    of_action_ofdpa_set_mpls_pcpdei_from_tunnel_table_pcp_dei_get(obj, &val8);
    out += writer(cookie, "pcp_dei=");
    out += LOCI_SHOW_u8_pcp_dei(writer, cookie, val8);
    out += writer(cookie, " ");
...
int
of_action_ofdpa_set_mpls_qos_from_table_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, of_action_ofdpa_set_mpls_qos_from_table_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint16_t val16;
    ...
    of_action_ofdpa_set_mpls_qos_from_table_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    of_action_ofdpa_set_mpls_qos_from_table_subtype_get(obj, &val16);
    out += writer(cookie, "subtype=");
    out += LOCI_SHOW_u16_subtype(writer, cookie, val16);
    out += writer(cookie, " ");

    of_action_ofdpa_set_mpls_qos_from_table_qos_index_get(obj, &val8);
    out += writer(cookie, "qos_index=");
    out += LOCI_SHOW_u8_qos_index(writer, cookie, val8);
    out += writer(cookie, " ");

    of_action_ofdpa_set_mpls_qos_from_table_mpls_tc_get(obj, &val8);
    out += writer(cookie, "mpls_tc=");
    out += LOCI_SHOW_u8_mpls_tc(writer, cookie, val8);
    out += writer(cookie, " ");
...
of_action_ofdpa_set_mpls_tc_from_tunnel_table_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, of_action_ofdpa_set_mpls_tc_from_tunnel_table_t *obj)
{
    ...
    of_action_ofdpa_set_mpls_tc_from_tunnel_table_qos_index_get(obj, &val8);
    out += writer(cookie, "qos_index=");
    out += LOCI_SHOW_u8_qos_index(writer, cookie, val8);
    out += writer(cookie, " ");
    ...
    of_action_ofdpa_set_mpls_tc_from_tunnel_table_mpls_tc_get(obj, &val8);
    out += writer(cookie, "mpls_tc=");
    out += LOCI_SHOW_u8_mpls_tc(writer, cookie, val8);
    out += writer(cookie, " ");
...
of_action_ofdpa_set_mpls_tc_from_vpn_table_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, of_action_ofdpa_set_mpls_tc_from_vpn_table_t *obj)
{
    ...
    of_action_ofdpa_set_mpls_tc_from_vpn_table_qos_index_get(obj, &val8);
    out += writer(cookie, "qos_index=");
    out += LOCI_SHOW_u8_qos_index(writer, cookie, val8);
    out += writer(cookie, " ");
    ...
    of_action_ofdpa_set_mpls_tc_from_vpn_table_mpls_tc_get(obj, &val8);
    out += writer(cookie, "mpls_tc=");
    out += LOCI_SHOW_u8_mpls_tc(writer, cookie, val8);
    out += writer(cookie, " ");
...
of_action_ofdpa_set_pcpdei_from_table_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, of_action_ofdpa_set_pcpdei_from_table_t *obj)
{
    ...
    of_action_ofdpa_set_pcpdei_from_table_qos_index_get(obj, &val8);
    out += writer(cookie, "qos_index=");
    out += LOCI_SHOW_u8_qos_index(writer, cookie, val8);
    out += writer(cookie, " ");
...
int
of_oxm_ofdpa_bfd_discriminator_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, of_oxm_ofdpa_bfd_discriminator_t *obj)
{
    int out = 0;
    uint32_t val32;

    of_oxm_ofdpa_bfd_discriminator_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    of_oxm_ofdpa_bfd_discriminator_value_get(obj, &val32);
    out += writer(cookie, "value=");
    out += LOCI_SHOW_u32_value(writer, cookie, val32);
    out += writer(cookie, " ");
...
int
of_oxm_ofdpa_bfd_discriminator_masked_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, of_oxm_ofdpa_bfd_discriminator_masked_t *obj)
{
    int out = 0;
    uint32_t val32;

    of_oxm_ofdpa_bfd_discriminator_masked_experimenter_get(obj, &val32);
    out += writer(cookie, "experimenter=");
    out += LOCI_SHOW_u32_experimenter(writer, cookie, val32);
    out += writer(cookie, " ");

    of_oxm_ofdpa_bfd_discriminator_masked_value_get(obj, &val32);
    out += writer(cookie, "value=");
    out += LOCI_SHOW_u32_value(writer, cookie, val32);
    out += writer(cookie, " ");

    of_oxm_ofdpa_bfd_discriminator_masked_value_mask_get(obj, &val32);
    out += writer(cookie, "value_mask=");
    out += LOCI_SHOW_u32_value_mask(writer, cookie, val32);
    out += writer(cookie, " ");
...
loci_show_match(loci_writer_f writer, void* cookie, of_match_t *match)
{
    ...
    if (OF_MATCH_MASK_OFDPA_BFD_DISCRIMINATOR_ACTIVE_TEST(match)) {
        out += writer(cookie, "ofdpa_bfd_discriminator active=");
        out += LOCI_SHOW_u32_ofdpa_bfd_discriminator(writer, cookie, match->fields.ofdpa_bfd_discriminator);
        out += writer(cookie, "/");
        out += LOCI_SHOW_u32_ofdpa_bfd_discriminator(writer, cookie, match->masks.ofdpa_bfd_discriminator);
        out += writer(cookie, " ");
    }
...
static const loci_obj_show_f show_funs_v4[OF_OBJECT_COUNT] = {
    ...
    ofdpa_class_based_ctr_mod_msg_OF_VERSION_1_3_show,
    ofdpa_class_based_ctr_multipart_reply_OF_VERSION_1_3_show,
    ofdpa_class_based_ctr_multipart_request_OF_VERSION_1_3_show,
    ofdpa_color_based_ctr_mod_msg_OF_VERSION_1_3_show,
    ofdpa_color_based_ctr_multipart_reply_OF_VERSION_1_3_show,
    ofdpa_color_based_ctr_multipart_request_OF_VERSION_1_3_show,
    ofdpa_l2_interface_remark_action_mod_msg_OF_VERSION_1_3_show,
    ofdpa_l2_interface_remark_action_multipart_reply_OF_VERSION_1_3_show,
    ofdpa_l2_interface_remark_action_multipart_request_OF_VERSION_1_3_show,
    ofdpa_mpls_set_qos_action_mod_msg_OF_VERSION_1_3_show,
    ofdpa_mpls_set_qos_action_multipart_reply_OF_VERSION_1_3_show,
    ofdpa_mpls_set_qos_action_multipart_request_OF_VERSION_1_3_show,
    ofdpa_mpls_tunnel_label_multipart_reply_OF_VERSION_1_3_show,
    ofdpa_mpls_tunnel_label_multipart_request_OF_VERSION_1_3_show,
    ofdpa_mpls_tunnel_label_remark_action_mod_msg_OF_VERSION_1_3_show,
    ofdpa_mpls_vpn_label_remark_action_mod_msg_OF_VERSION_1_3_show,
    ofdpa_mpls_vpn_label_remark_action_multipart_reply_OF_VERSION_1_3_show,
    ofdpa_mpls_vpn_label_remark_action_multipart_request_OF_VERSION_1_3_show,
    ofdpa_oam_dataplane_ctr_mod_msg_OF_VERSION_1_3_show,
    ofdpa_oam_dataplane_ctr_multipart_reply_OF_VERSION_1_3_show,
    ofdpa_oam_dataplane_ctr_multipart_request_OF_VERSION_1_3_show,
    ofdpa_oam_drop_status_mod_msg_OF_VERSION_1_3_show,
    ofdpa_oam_drop_status_multipart_reply_OF_VERSION_1_3_show,
    ofdpa_oam_drop_status_multipart_request_OF_VERSION_1_3_show,
    ofdpa_port_experimenter_prop_scheduling_OF_VERSION_1_3_show,
    ofdpa_queue_desc_prop_congestion_multipart_reply_OF_VERSION_1_3_show,
    ofdpa_queue_desc_prop_congestion_multipart_request_OF_VERSION_1_3_show,
    ofdpa_queue_desc_prop_parent_multipart_reply_OF_VERSION_1_3_show,
    ofdpa_queue_desc_prop_parent_multipart_request_OF_VERSION_1_3_show,
    ofdpa_queue_mod_OF_VERSION_1_3_show,
    ofdpa_scheduler_node_mod_msg_OF_VERSION_1_3_show,
    ofdpa_scheduler_node_multipart_request_OF_VERSION_1_3_show,
    ofdpa_scheduler_node_multipart_response_OF_VERSION_1_3_show,
    unknown_show,
    ...
    of_action_id_ofdpa_class_based_rx_count_OF_VERSION_1_3_show,
    of_action_id_ofdpa_class_based_tx_count_OF_VERSION_1_3_show,
    of_action_id_ofdpa_color_based_rx_count_OF_VERSION_1_3_show,
    of_action_id_ofdpa_color_based_tx_count_OF_VERSION_1_3_show,
    ...
    of_action_id_ofdpa_set_mpls_qos_from_table_OF_VERSION_1_3_show,
    ...
    of_action_ofdpa_class_based_rx_count_OF_VERSION_1_3_show,
    of_action_ofdpa_class_based_tx_count_OF_VERSION_1_3_show,
    of_action_ofdpa_color_based_rx_count_OF_VERSION_1_3_show,
    of_action_ofdpa_color_based_tx_count_OF_VERSION_1_3_show,
    ...
    of_action_ofdpa_set_mpls_qos_from_table_OF_VERSION_1_3_show,
    ...
    of_oxm_ofdpa_bfd_discriminator_OF_VERSION_1_3_show,
    of_oxm_ofdpa_bfd_discriminator_masked_OF_VERSION_1_3_show,

...
const char *const of_object_id_str[] = {
    ...
    "ofdpa_class_based_ctr_mod_msg",
    "ofdpa_class_based_ctr_multipart_reply",
    "ofdpa_class_based_ctr_multipart_request",
    "ofdpa_color_based_ctr_mod_msg",
    "ofdpa_color_based_ctr_multipart_reply",
    "ofdpa_color_based_ctr_multipart_request",
    "ofdpa_l2_interface_remark_action_mod_msg",
    "ofdpa_l2_interface_remark_action_multipart_reply",
    "ofdpa_l2_interface_remark_action_multipart_request",
    "ofdpa_mpls_set_qos_action_mod_msg",
    "ofdpa_mpls_set_qos_action_multipart_reply",
    "ofdpa_mpls_set_qos_action_multipart_request",
    "ofdpa_mpls_tunnel_label_multipart_reply",
    "ofdpa_mpls_tunnel_label_multipart_request",
    "ofdpa_mpls_tunnel_label_remark_action_mod_msg",
    "ofdpa_mpls_vpn_label_remark_action_mod_msg",
    "ofdpa_mpls_vpn_label_remark_action_multipart_reply",
    "ofdpa_mpls_vpn_label_remark_action_multipart_request",
    "ofdpa_oam_dataplane_ctr_mod_msg",
    "ofdpa_oam_dataplane_ctr_multipart_reply",
    "ofdpa_oam_dataplane_ctr_multipart_request",
    "ofdpa_oam_drop_status_mod_msg",
    "ofdpa_oam_drop_status_multipart_reply",
    "ofdpa_oam_drop_status_multipart_request",
    "ofdpa_port_experimenter_prop_scheduling",
    "ofdpa_queue_desc_prop_congestion_multipart_reply",
    "ofdpa_queue_desc_prop_congestion_multipart_request",
    "ofdpa_queue_desc_prop_parent_multipart_reply",
    "ofdpa_queue_desc_prop_parent_multipart_request",
    "ofdpa_queue_mod",
    "ofdpa_scheduler_node_mod_msg",
    "ofdpa_scheduler_node_multipart_request",
    "ofdpa_scheduler_node_multipart_response",
    "of_action",
    "of_action_bsn",
    ...
    "of_action_id_ofdpa_class_based_rx_count",
    "of_action_id_ofdpa_class_based_tx_count",
    "of_action_id_ofdpa_color_based_rx_count",
    "of_action_id_ofdpa_color_based_tx_count",
    ...
    "of_action_id_ofdpa_set_mpls_qos_from_table",
    ...
    "of_action_ofdpa_class_based_rx_count",
    "of_action_ofdpa_class_based_tx_count",
    "of_action_ofdpa_color_based_rx_count",
    "of_action_ofdpa_color_based_tx_count",
    ...
    "of_action_ofdpa_set_mpls_qos_from_table",
    ...
    "of_oxm_ofdpa_bfd_discriminator",
    "of_oxm_ofdpa_bfd_discriminator_masked",
    "of_oxm_ofdpa_color",

...
of_experimenter_multipart_reply_ofdpa_wire_object_id_get(of_object_t *obj, of_object_id_t *id)
{
    ...
    case OF_VERSION_1_3: {
        ...
        switch (value) {
        case 0x1:
            *id = OFDPA_MPLS_SET_QOS_ACTION_MULTIPART_REPLY;
            break;
        case 0x3:
            *id = OFDPA_OAM_DATAPLANE_CTR_MULTIPART_REPLY;
            break;
        case 0x5:
            *id = OFDPA_OAM_DROP_STATUS_MULTIPART_REPLY;
            break;
        case 0x7:
            *id = OFDPA_MPLS_VPN_LABEL_REMARK_ACTION_MULTIPART_REPLY;
            break;
        case 0x9:
            *id = OFDPA_MPLS_TUNNEL_LABEL_MULTIPART_REPLY;
            break;
        case 0xb:
            *id = OFDPA_L2_INTERFACE_REMARK_ACTION_MULTIPART_REPLY;
            break;
        case 0xd:
            *id = OFDPA_CLASS_BASED_CTR_MULTIPART_REPLY;
            break;
        case 0xf:
            *id = OFDPA_COLOR_BASED_CTR_MULTIPART_REPLY;
            break;
        case 0x12:
            *id = OFDPA_QUEUE_DESC_PROP_PARENT_MULTIPART_REPLY;
            break;
        case 0x13:
            *id = OFDPA_QUEUE_DESC_PROP_CONGESTION_MULTIPART_REPLY;
            break;
        default:
...
of_experimenter_multipart_request_ofdpa_wire_object_id_get(of_object_t *obj, of_object_id_t *id)
{
    ...
    case OF_VERSION_1_3: {
        ...
        switch (value) {
        case 0x1:
            *id = OFDPA_MPLS_SET_QOS_ACTION_MULTIPART_REQUEST;
            break;
        case 0x3:
            *id = OFDPA_OAM_DATAPLANE_CTR_MULTIPART_REQUEST;
            break;
        case 0x5:
            *id = OFDPA_OAM_DROP_STATUS_MULTIPART_REQUEST;
            break;
        case 0x7:
            *id = OFDPA_MPLS_VPN_LABEL_REMARK_ACTION_MULTIPART_REQUEST;
            break;
        case 0x9:
            *id = OFDPA_MPLS_TUNNEL_LABEL_MULTIPART_REQUEST;
            break;
        case 0xb:
            *id = OFDPA_L2_INTERFACE_REMARK_ACTION_MULTIPART_REQUEST;
            break;
        case 0xd:
            *id = OFDPA_CLASS_BASED_CTR_MULTIPART_REQUEST;
            break;
        case 0xf:
            *id = OFDPA_COLOR_BASED_CTR_MULTIPART_REQUEST;
            break;
        case 0x12:
            *id = OFDPA_QUEUE_DESC_PROP_PARENT_MULTIPART_REQUEST;
            break;
        case 0x13:
            *id = OFDPA_QUEUE_DESC_PROP_CONGESTION_MULTIPART_REQUEST;
            break;
        default:
...
of_experimenter_ofdpa_wire_object_id_get(of_object_t *obj, of_object_id_t *id)
{
    ...
    case OF_VERSION_1_3: {
        ...
        switch (value) {
        case 0x0:
            *id = OFDPA_MPLS_SET_QOS_ACTION_MOD_MSG;
            break;
        case 0x2:
            *id = OFDPA_OAM_DATAPLANE_CTR_MOD_MSG;
            break;
        case 0x4:
            *id = OFDPA_OAM_DROP_STATUS_MOD_MSG;
            break;
        case 0x6:
            *id = OFDPA_MPLS_VPN_LABEL_REMARK_ACTION_MOD_MSG;
            break;
        case 0x8:
            *id = OFDPA_MPLS_TUNNEL_LABEL_REMARK_ACTION_MOD_MSG;
            break;
        case 0xa:
            *id = OFDPA_L2_INTERFACE_REMARK_ACTION_MOD_MSG;
            break;
        case 0xc:
            *id = OFDPA_CLASS_BASED_CTR_MOD_MSG;
            break;
        case 0xe:
            *id = OFDPA_COLOR_BASED_CTR_MOD_MSG;
            break;
        case 0x11:
            *id = OFDPA_QUEUE_MOD;
            break;
        case 0x14:
            *id = OFDPA_SCHEDULER_NODE_MOD_MSG;
            break;
        default:

    ...
    case OF_VERSION_1_3: {
        ...
        case 0xe:
            *id = OF_ACTION_OFDPA_CHECK_DROP_STATUS;
            break;
        case 0xf:
            *id = OF_ACTION_OFDPA_SET_MPLS_QOS_FROM_TABLE;
            break;
        case 0x10:
        ...
        case 0x12:
            *id = OF_ACTION_OFDPA_SET_MPLS_PCPDEI_FROM_TUNNEL_TABLE;
            break;
        case 0x13:
            *id = OF_ACTION_OFDPA_CLASS_BASED_TX_COUNT;
            break;
        case 0x14:
            *id = OF_ACTION_OFDPA_CLASS_BASED_RX_COUNT;
            break;
        case 0x15:
            *id = OF_ACTION_OFDPA_COLOR_BASED_TX_COUNT;
            break;
        case 0x16:
            *id = OF_ACTION_OFDPA_COLOR_BASED_RX_COUNT;
            break;
        default:
            *id = OF_ACTION_OFDPA;
            break;
    ...
    case OF_VERSION_1_3: {
        ...
        case 0xe:
            *id = OF_ACTION_ID_OFDPA_CHECK_DROP_STATUS;
            break;
        case 0xf:
            *id = OF_ACTION_ID_OFDPA_SET_MPLS_QOS_FROM_TABLE;
            break;
        case 0x10:
        ...
        case 0x12:
            *id = OF_ACTION_ID_OFDPA_SET_MPLS_PCPDEI_FROM_TUNNEL_TABLE;
            break;
        case 0x13:
            *id = OF_ACTION_ID_OFDPA_CLASS_BASED_TX_COUNT;
            break;
        case 0x14:
            *id = OF_ACTION_ID_OFDPA_CLASS_BASED_RX_COUNT;
            break;
        case 0x15:
            *id = OF_ACTION_ID_OFDPA_COLOR_BASED_TX_COUNT;
            break;
        case 0x16:
            *id = OF_ACTION_ID_OFDPA_COLOR_BASED_RX_COUNT;
            break;
        default:
...
static void
of_action_ofdpa_class_based_rx_count_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_3:
...
/**
 * \defgroup of_action_ofdpa_class_based_rx_count of_action_ofdpa_class_based_rx_count
 */
 ...
 */
static inline int
of_action_ofdpa_class_based_rx_count_push_wire_values(of_action_ofdpa_class_based_rx_count_t *obj)
{

    of_action_ofdpa_class_based_rx_count_push_wire_types(obj);
...
/**
 * Create a new of_action_ofdpa_class_based_rx_count object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
of_action_ofdpa_class_based_rx_count_t *
of_action_ofdpa_class_based_rx_count_new(of_version_t version)
{
    of_action_ofdpa_class_based_rx_count_t *obj;
    int bytes;

    bytes = of_object_fixed_len[version][OF_ACTION_OFDPA_CLASS_BASED_RX_COUNT] + of_object_extra_len[version][OF_ACTION_OFDPA_CLASS_BASED_RX_COUNT];

    /* Allocate a maximum-length wire buffer assuming we'll be appending to it. */
    if ((obj = (of_action_ofdpa_class_based_rx_count_t *)of_object_new(OF_WIRE_BUFFER_MAX_LENGTH)) == NULL) {
        return NULL;
    }

    of_action_ofdpa_class_based_rx_count_init(obj, version, bytes, 0);

    if (of_action_ofdpa_class_based_rx_count_push_wire_values(obj) < 0) {
        FREE(obj);
        return NULL;
    }
...
/**
 * Initialize an object of type of_action_ofdpa_class_based_rx_count.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_action_ofdpa_class_based_rx_count_init(of_action_ofdpa_class_based_rx_count_t *obj,
    of_version_t version, int bytes, int clean_wire)
{

    LOCI_ASSERT(of_object_fixed_len[version][OF_ACTION_OFDPA_CLASS_BASED_RX_COUNT] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_ACTION_OFDPA_CLASS_BASED_RX_COUNT;

    /* Set up the object's function pointers */

    obj->wire_type_set = of_action_ofdpa_class_based_rx_count_push_wire_types;
...
/**
 * Get experimenter from an object of type of_action_ofdpa_class_based_rx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_class_based_rx_count.
 * @param experimenter Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_action_ofdpa_class_based_rx_count_experimenter_get(
    of_action_ofdpa_class_based_rx_count_t *obj,
    uint32_t *experimenter)
{
    of_wire_buffer_t *wbuf;
    ...
    LOCI_ASSERT(obj->object_id == OF_ACTION_OFDPA_CLASS_BASED_RX_COUNT);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set experimenter in an object of type of_action_ofdpa_class_based_rx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_class_based_rx_count.
 * @param experimenter The value to write into the object
 */
void
of_action_ofdpa_class_based_rx_count_experimenter_set(
    of_action_ofdpa_class_based_rx_count_t *obj,
    uint32_t experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get subtype from an object of type of_action_ofdpa_class_based_rx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_class_based_rx_count.
 * @param subtype Pointer to the child object of type
 * uint16_t to be filled out.
 *
 */
void
of_action_ofdpa_class_based_rx_count_subtype_get(
    of_action_ofdpa_class_based_rx_count_t *obj,
    uint16_t *subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set subtype in an object of type of_action_ofdpa_class_based_rx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_class_based_rx_count.
 * @param subtype The value to write into the object
 */
void
of_action_ofdpa_class_based_rx_count_subtype_set(
    of_action_ofdpa_class_based_rx_count_t *obj,
    uint16_t subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get traffic_class from an object of type of_action_ofdpa_class_based_rx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_class_based_rx_count.
 ...
 */
void
of_action_ofdpa_class_based_rx_count_traffic_class_get(
    of_action_ofdpa_class_based_rx_count_t *obj,
...
/**
 * Set traffic_class in an object of type of_action_ofdpa_class_based_rx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_class_based_rx_count.
 * @param traffic_class The value to write into the object
 */
void
of_action_ofdpa_class_based_rx_count_traffic_class_set(
    of_action_ofdpa_class_based_rx_count_t *obj,
    uint16_t traffic_class)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get index from an object of type of_action_ofdpa_class_based_rx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_class_based_rx_count.
 ...
 */
void
of_action_ofdpa_class_based_rx_count_index_get(
    of_action_ofdpa_class_based_rx_count_t *obj,
    uint32_t *index)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set index in an object of type of_action_ofdpa_class_based_rx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_class_based_rx_count.
 * @param index The value to write into the object
 */
void
of_action_ofdpa_class_based_rx_count_index_set(
    of_action_ofdpa_class_based_rx_count_t *obj,
    uint32_t index)
{
    of_wire_buffer_t *wbuf;
...
static void
of_action_id_ofdpa_class_based_rx_count_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_3:
...
/**
 * \defgroup of_action_id_ofdpa_class_based_rx_count of_action_id_ofdpa_class_based_rx_count
 */
 ...
 */
static inline int
of_action_id_ofdpa_class_based_rx_count_push_wire_values(of_action_id_ofdpa_class_based_rx_count_t *obj)
{

    of_action_id_ofdpa_class_based_rx_count_push_wire_types(obj);
...
/**
 * Create a new of_action_id_ofdpa_class_based_rx_count object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
of_action_id_ofdpa_class_based_rx_count_t *
of_action_id_ofdpa_class_based_rx_count_new(of_version_t version)
{
    of_action_id_ofdpa_class_based_rx_count_t *obj;
    int bytes;

    bytes = of_object_fixed_len[version][OF_ACTION_ID_OFDPA_CLASS_BASED_RX_COUNT] + of_object_extra_len[version][OF_ACTION_ID_OFDPA_CLASS_BASED_RX_COUNT];

    /* Allocate a maximum-length wire buffer assuming we'll be appending to it. */
    if ((obj = (of_action_id_ofdpa_class_based_rx_count_t *)of_object_new(OF_WIRE_BUFFER_MAX_LENGTH)) == NULL) {
        return NULL;
    }

    of_action_id_ofdpa_class_based_rx_count_init(obj, version, bytes, 0);

    if (of_action_id_ofdpa_class_based_rx_count_push_wire_values(obj) < 0) {
        FREE(obj);
        return NULL;
    }
...
/**
 * Initialize an object of type of_action_id_ofdpa_class_based_rx_count.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_action_id_ofdpa_class_based_rx_count_init(of_action_id_ofdpa_class_based_rx_count_t *obj,
    of_version_t version, int bytes, int clean_wire)
{

    LOCI_ASSERT(of_object_fixed_len[version][OF_ACTION_ID_OFDPA_CLASS_BASED_RX_COUNT] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_ACTION_ID_OFDPA_CLASS_BASED_RX_COUNT;

    /* Set up the object's function pointers */

    obj->wire_type_set = of_action_id_ofdpa_class_based_rx_count_push_wire_types;
...
/**
 * Get experimenter from an object of type of_action_id_ofdpa_class_based_rx_count.
 * @param obj Pointer to an object of type of_action_id_ofdpa_class_based_rx_count.
 * @param experimenter Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_action_id_ofdpa_class_based_rx_count_experimenter_get(
    of_action_id_ofdpa_class_based_rx_count_t *obj,
    uint32_t *experimenter)
{
    of_wire_buffer_t *wbuf;
    ...
    LOCI_ASSERT(obj->object_id == OF_ACTION_ID_OFDPA_CLASS_BASED_RX_COUNT);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set experimenter in an object of type of_action_id_ofdpa_class_based_rx_count.
 * @param obj Pointer to an object of type of_action_id_ofdpa_class_based_rx_count.
 * @param experimenter The value to write into the object
 */
void
of_action_id_ofdpa_class_based_rx_count_experimenter_set(
    of_action_id_ofdpa_class_based_rx_count_t *obj,
    uint32_t experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get subtype from an object of type of_action_id_ofdpa_class_based_rx_count.
 * @param obj Pointer to an object of type of_action_id_ofdpa_class_based_rx_count.
 * @param subtype Pointer to the child object of type
 * uint16_t to be filled out.
 *
 */
void
of_action_id_ofdpa_class_based_rx_count_subtype_get(
    of_action_id_ofdpa_class_based_rx_count_t *obj,
    uint16_t *subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set subtype in an object of type of_action_id_ofdpa_class_based_rx_count.
 * @param obj Pointer to an object of type of_action_id_ofdpa_class_based_rx_count.
 * @param subtype The value to write into the object
 */
void
of_action_id_ofdpa_class_based_rx_count_subtype_set(
    of_action_id_ofdpa_class_based_rx_count_t *obj,
    uint16_t subtype)
{
    of_wire_buffer_t *wbuf;
...
static void
of_action_ofdpa_class_based_tx_count_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_3:
...
/**
 * \defgroup of_action_ofdpa_class_based_tx_count of_action_ofdpa_class_based_tx_count
 */
 ...
 */
static inline int
of_action_ofdpa_class_based_tx_count_push_wire_values(of_action_ofdpa_class_based_tx_count_t *obj)
{

    of_action_ofdpa_class_based_tx_count_push_wire_types(obj);
...
/**
 * Create a new of_action_ofdpa_class_based_tx_count object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
of_action_ofdpa_class_based_tx_count_t *
of_action_ofdpa_class_based_tx_count_new(of_version_t version)
{
    of_action_ofdpa_class_based_tx_count_t *obj;
    int bytes;

    bytes = of_object_fixed_len[version][OF_ACTION_OFDPA_CLASS_BASED_TX_COUNT] + of_object_extra_len[version][OF_ACTION_OFDPA_CLASS_BASED_TX_COUNT];

    /* Allocate a maximum-length wire buffer assuming we'll be appending to it. */
    if ((obj = (of_action_ofdpa_class_based_tx_count_t *)of_object_new(OF_WIRE_BUFFER_MAX_LENGTH)) == NULL) {
        return NULL;
    }

    of_action_ofdpa_class_based_tx_count_init(obj, version, bytes, 0);

    if (of_action_ofdpa_class_based_tx_count_push_wire_values(obj) < 0) {
        FREE(obj);
        return NULL;
    }
...
/**
 * Initialize an object of type of_action_ofdpa_class_based_tx_count.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_action_ofdpa_class_based_tx_count_init(of_action_ofdpa_class_based_tx_count_t *obj,
    of_version_t version, int bytes, int clean_wire)
{

    LOCI_ASSERT(of_object_fixed_len[version][OF_ACTION_OFDPA_CLASS_BASED_TX_COUNT] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_ACTION_OFDPA_CLASS_BASED_TX_COUNT;

    /* Set up the object's function pointers */

    obj->wire_type_set = of_action_ofdpa_class_based_tx_count_push_wire_types;
...
/**
 * Get experimenter from an object of type of_action_ofdpa_class_based_tx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_class_based_tx_count.
 * @param experimenter Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_action_ofdpa_class_based_tx_count_experimenter_get(
    of_action_ofdpa_class_based_tx_count_t *obj,
    uint32_t *experimenter)
{
    of_wire_buffer_t *wbuf;
    ...
    LOCI_ASSERT(obj->object_id == OF_ACTION_OFDPA_CLASS_BASED_TX_COUNT);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set experimenter in an object of type of_action_ofdpa_class_based_tx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_class_based_tx_count.
 * @param experimenter The value to write into the object
 */
void
of_action_ofdpa_class_based_tx_count_experimenter_set(
    of_action_ofdpa_class_based_tx_count_t *obj,
    uint32_t experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get subtype from an object of type of_action_ofdpa_class_based_tx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_class_based_tx_count.
 * @param subtype Pointer to the child object of type
 * uint16_t to be filled out.
 *
 */
void
of_action_ofdpa_class_based_tx_count_subtype_get(
    of_action_ofdpa_class_based_tx_count_t *obj,
    uint16_t *subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set subtype in an object of type of_action_ofdpa_class_based_tx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_class_based_tx_count.
 * @param subtype The value to write into the object
 */
void
of_action_ofdpa_class_based_tx_count_subtype_set(
    of_action_ofdpa_class_based_tx_count_t *obj,
    uint16_t subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get traffic_class from an object of type of_action_ofdpa_class_based_tx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_class_based_tx_count.
 * @param traffic_class Pointer to the child object of type
 * uint16_t to be filled out.
 *
 */
void
of_action_ofdpa_class_based_tx_count_traffic_class_get(
    of_action_ofdpa_class_based_tx_count_t *obj,
    uint16_t *traffic_class)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set traffic_class in an object of type of_action_ofdpa_class_based_tx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_class_based_tx_count.
 * @param traffic_class The value to write into the object
 */
void
of_action_ofdpa_class_based_tx_count_traffic_class_set(
    of_action_ofdpa_class_based_tx_count_t *obj,
    uint16_t traffic_class)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get index from an object of type of_action_ofdpa_class_based_tx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_class_based_tx_count.
 * @param index Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_action_ofdpa_class_based_tx_count_index_get(
    of_action_ofdpa_class_based_tx_count_t *obj,
    uint32_t *index)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set index in an object of type of_action_ofdpa_class_based_tx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_class_based_tx_count.
 * @param index The value to write into the object
 */
void
of_action_ofdpa_class_based_tx_count_index_set(
    of_action_ofdpa_class_based_tx_count_t *obj,
    uint32_t index)
{
    of_wire_buffer_t *wbuf;
...
static void
of_action_id_ofdpa_class_based_tx_count_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_3:
...
/**
 * \defgroup of_action_id_ofdpa_class_based_tx_count of_action_id_ofdpa_class_based_tx_count
 */
 ...
 */
static inline int
of_action_id_ofdpa_class_based_tx_count_push_wire_values(of_action_id_ofdpa_class_based_tx_count_t *obj)
{

    of_action_id_ofdpa_class_based_tx_count_push_wire_types(obj);
...
/**
 * Create a new of_action_id_ofdpa_class_based_tx_count object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
of_action_id_ofdpa_class_based_tx_count_t *
of_action_id_ofdpa_class_based_tx_count_new(of_version_t version)
{
    of_action_id_ofdpa_class_based_tx_count_t *obj;
    int bytes;

    bytes = of_object_fixed_len[version][OF_ACTION_ID_OFDPA_CLASS_BASED_TX_COUNT] + of_object_extra_len[version][OF_ACTION_ID_OFDPA_CLASS_BASED_TX_COUNT];

    /* Allocate a maximum-length wire buffer assuming we'll be appending to it. */
    if ((obj = (of_action_id_ofdpa_class_based_tx_count_t *)of_object_new(OF_WIRE_BUFFER_MAX_LENGTH)) == NULL) {
        return NULL;
    }

    of_action_id_ofdpa_class_based_tx_count_init(obj, version, bytes, 0);

    if (of_action_id_ofdpa_class_based_tx_count_push_wire_values(obj) < 0) {
        FREE(obj);
        return NULL;
    }
...
/**
 * Initialize an object of type of_action_id_ofdpa_class_based_tx_count.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_action_id_ofdpa_class_based_tx_count_init(of_action_id_ofdpa_class_based_tx_count_t *obj,
    of_version_t version, int bytes, int clean_wire)
{

    LOCI_ASSERT(of_object_fixed_len[version][OF_ACTION_ID_OFDPA_CLASS_BASED_TX_COUNT] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_ACTION_ID_OFDPA_CLASS_BASED_TX_COUNT;

    /* Set up the object's function pointers */

    obj->wire_type_set = of_action_id_ofdpa_class_based_tx_count_push_wire_types;
...
/**
 * Get experimenter from an object of type of_action_id_ofdpa_class_based_tx_count.
 * @param obj Pointer to an object of type of_action_id_ofdpa_class_based_tx_count.
 * @param experimenter Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_action_id_ofdpa_class_based_tx_count_experimenter_get(
    of_action_id_ofdpa_class_based_tx_count_t *obj,
    uint32_t *experimenter)
{
    of_wire_buffer_t *wbuf;
    ...
    LOCI_ASSERT(obj->object_id == OF_ACTION_ID_OFDPA_CLASS_BASED_TX_COUNT);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set experimenter in an object of type of_action_id_ofdpa_class_based_tx_count.
 * @param obj Pointer to an object of type of_action_id_ofdpa_class_based_tx_count.
 * @param experimenter The value to write into the object
 */
void
of_action_id_ofdpa_class_based_tx_count_experimenter_set(
    of_action_id_ofdpa_class_based_tx_count_t *obj,
    uint32_t experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get subtype from an object of type of_action_id_ofdpa_class_based_tx_count.
 * @param obj Pointer to an object of type of_action_id_ofdpa_class_based_tx_count.
 * @param subtype Pointer to the child object of type
 * uint16_t to be filled out.
 *
 */
void
of_action_id_ofdpa_class_based_tx_count_subtype_get(
    of_action_id_ofdpa_class_based_tx_count_t *obj,
    uint16_t *subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set subtype in an object of type of_action_id_ofdpa_class_based_tx_count.
 * @param obj Pointer to an object of type of_action_id_ofdpa_class_based_tx_count.
 * @param subtype The value to write into the object
 */
void
of_action_id_ofdpa_class_based_tx_count_subtype_set(
    of_action_id_ofdpa_class_based_tx_count_t *obj,
    uint16_t subtype)
{
    of_wire_buffer_t *wbuf;
...
static void
of_action_ofdpa_color_based_rx_count_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_3:
...
/**
 * \defgroup of_action_ofdpa_color_based_rx_count of_action_ofdpa_color_based_rx_count
 */
 ...
 */
static inline int
of_action_ofdpa_color_based_rx_count_push_wire_values(of_action_ofdpa_color_based_rx_count_t *obj)
{

    of_action_ofdpa_color_based_rx_count_push_wire_types(obj);
...
/**
 * Create a new of_action_ofdpa_color_based_rx_count object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
of_action_ofdpa_color_based_rx_count_t *
of_action_ofdpa_color_based_rx_count_new(of_version_t version)
{
    of_action_ofdpa_color_based_rx_count_t *obj;
    int bytes;

    bytes = of_object_fixed_len[version][OF_ACTION_OFDPA_COLOR_BASED_RX_COUNT] + of_object_extra_len[version][OF_ACTION_OFDPA_COLOR_BASED_RX_COUNT];

    /* Allocate a maximum-length wire buffer assuming we'll be appending to it. */
    if ((obj = (of_action_ofdpa_color_based_rx_count_t *)of_object_new(OF_WIRE_BUFFER_MAX_LENGTH)) == NULL) {
        return NULL;
    }

    of_action_ofdpa_color_based_rx_count_init(obj, version, bytes, 0);

    if (of_action_ofdpa_color_based_rx_count_push_wire_values(obj) < 0) {
        FREE(obj);
        return NULL;
    }
...
/**
 * Initialize an object of type of_action_ofdpa_color_based_rx_count.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_action_ofdpa_color_based_rx_count_init(of_action_ofdpa_color_based_rx_count_t *obj,
    of_version_t version, int bytes, int clean_wire)
{

    LOCI_ASSERT(of_object_fixed_len[version][OF_ACTION_OFDPA_COLOR_BASED_RX_COUNT] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_ACTION_OFDPA_COLOR_BASED_RX_COUNT;

    /* Set up the object's function pointers */

    obj->wire_type_set = of_action_ofdpa_color_based_rx_count_push_wire_types;
...
/**
 * Get experimenter from an object of type of_action_ofdpa_color_based_rx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_color_based_rx_count.
 * @param experimenter Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_action_ofdpa_color_based_rx_count_experimenter_get(
    of_action_ofdpa_color_based_rx_count_t *obj,
    uint32_t *experimenter)
{
    of_wire_buffer_t *wbuf;
    ...
    LOCI_ASSERT(obj->object_id == OF_ACTION_OFDPA_COLOR_BASED_RX_COUNT);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set experimenter in an object of type of_action_ofdpa_color_based_rx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_color_based_rx_count.
 * @param experimenter The value to write into the object
 */
void
of_action_ofdpa_color_based_rx_count_experimenter_set(
    of_action_ofdpa_color_based_rx_count_t *obj,
    uint32_t experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get subtype from an object of type of_action_ofdpa_color_based_rx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_color_based_rx_count.
 * @param subtype Pointer to the child object of type
 * uint16_t to be filled out.
 *
 */
void
of_action_ofdpa_color_based_rx_count_subtype_get(
    of_action_ofdpa_color_based_rx_count_t *obj,
    uint16_t *subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set subtype in an object of type of_action_ofdpa_color_based_rx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_color_based_rx_count.
 * @param subtype The value to write into the object
 */
void
of_action_ofdpa_color_based_rx_count_subtype_set(
    of_action_ofdpa_color_based_rx_count_t *obj,
    uint16_t subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get act_color from an object of type of_action_ofdpa_color_based_rx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_color_based_rx_count.
 * @param act_color Pointer to the child object of type
 * uint16_t to be filled out.
 *
 */
void
of_action_ofdpa_color_based_rx_count_act_color_get(
    of_action_ofdpa_color_based_rx_count_t *obj,
    uint16_t *act_color)
{
    of_wire_buffer_t *wbuf;
    ...
    abs_offset = OF_OBJECT_ABSOLUTE_OFFSET(obj, offset);
    LOCI_ASSERT(abs_offset >= 0);
    of_wire_buffer_u16_get(wbuf, abs_offset, act_color);
...
/**
 * Set act_color in an object of type of_action_ofdpa_color_based_rx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_color_based_rx_count.
 * @param act_color The value to write into the object
 */
void
of_action_ofdpa_color_based_rx_count_act_color_set(
    of_action_ofdpa_color_based_rx_count_t *obj,
    uint16_t act_color)
{
    of_wire_buffer_t *wbuf;
    ...
    abs_offset = OF_OBJECT_ABSOLUTE_OFFSET(obj, offset);
    LOCI_ASSERT(abs_offset >= 0);
    of_wire_buffer_u16_set(wbuf, abs_offset, act_color);
...
/**
 * Get index from an object of type of_action_ofdpa_color_based_rx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_color_based_rx_count.
 * @param index Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_action_ofdpa_color_based_rx_count_index_get(
    of_action_ofdpa_color_based_rx_count_t *obj,
    uint32_t *index)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set index in an object of type of_action_ofdpa_color_based_rx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_color_based_rx_count.
 * @param index The value to write into the object
 */
void
of_action_ofdpa_color_based_rx_count_index_set(
    of_action_ofdpa_color_based_rx_count_t *obj,
    uint32_t index)
{
    of_wire_buffer_t *wbuf;
...
static void
of_action_id_ofdpa_color_based_rx_count_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_3:
...
/**
 * \defgroup of_action_id_ofdpa_color_based_rx_count of_action_id_ofdpa_color_based_rx_count
 */
 ...
 */
static inline int
of_action_id_ofdpa_color_based_rx_count_push_wire_values(of_action_id_ofdpa_color_based_rx_count_t *obj)
{

    of_action_id_ofdpa_color_based_rx_count_push_wire_types(obj);
...
/**
 * Create a new of_action_id_ofdpa_color_based_rx_count object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
of_action_id_ofdpa_color_based_rx_count_t *
of_action_id_ofdpa_color_based_rx_count_new(of_version_t version)
{
    of_action_id_ofdpa_color_based_rx_count_t *obj;
    int bytes;

    bytes = of_object_fixed_len[version][OF_ACTION_ID_OFDPA_COLOR_BASED_RX_COUNT] + of_object_extra_len[version][OF_ACTION_ID_OFDPA_COLOR_BASED_RX_COUNT];

    /* Allocate a maximum-length wire buffer assuming we'll be appending to it. */
    if ((obj = (of_action_id_ofdpa_color_based_rx_count_t *)of_object_new(OF_WIRE_BUFFER_MAX_LENGTH)) == NULL) {
        return NULL;
    }

    of_action_id_ofdpa_color_based_rx_count_init(obj, version, bytes, 0);

    if (of_action_id_ofdpa_color_based_rx_count_push_wire_values(obj) < 0) {
        FREE(obj);
        return NULL;
    }
...
/**
 * Initialize an object of type of_action_id_ofdpa_color_based_rx_count.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_action_id_ofdpa_color_based_rx_count_init(of_action_id_ofdpa_color_based_rx_count_t *obj,
    of_version_t version, int bytes, int clean_wire)
{

    LOCI_ASSERT(of_object_fixed_len[version][OF_ACTION_ID_OFDPA_COLOR_BASED_RX_COUNT] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_ACTION_ID_OFDPA_COLOR_BASED_RX_COUNT;

    /* Set up the object's function pointers */

    obj->wire_type_set = of_action_id_ofdpa_color_based_rx_count_push_wire_types;
...
/**
 * Get experimenter from an object of type of_action_id_ofdpa_color_based_rx_count.
 * @param obj Pointer to an object of type of_action_id_ofdpa_color_based_rx_count.
 * @param experimenter Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_action_id_ofdpa_color_based_rx_count_experimenter_get(
    of_action_id_ofdpa_color_based_rx_count_t *obj,
    uint32_t *experimenter)
{
    of_wire_buffer_t *wbuf;
    ...
    LOCI_ASSERT(obj->object_id == OF_ACTION_ID_OFDPA_COLOR_BASED_RX_COUNT);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set experimenter in an object of type of_action_id_ofdpa_color_based_rx_count.
 * @param obj Pointer to an object of type of_action_id_ofdpa_color_based_rx_count.
 * @param experimenter The value to write into the object
 */
void
of_action_id_ofdpa_color_based_rx_count_experimenter_set(
    of_action_id_ofdpa_color_based_rx_count_t *obj,
    uint32_t experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get subtype from an object of type of_action_id_ofdpa_color_based_rx_count.
 * @param obj Pointer to an object of type of_action_id_ofdpa_color_based_rx_count.
 * @param subtype Pointer to the child object of type
 * uint16_t to be filled out.
 *
 */
void
of_action_id_ofdpa_color_based_rx_count_subtype_get(
    of_action_id_ofdpa_color_based_rx_count_t *obj,
    uint16_t *subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set subtype in an object of type of_action_id_ofdpa_color_based_rx_count.
 * @param obj Pointer to an object of type of_action_id_ofdpa_color_based_rx_count.
 * @param subtype The value to write into the object
 */
void
of_action_id_ofdpa_color_based_rx_count_subtype_set(
    of_action_id_ofdpa_color_based_rx_count_t *obj,
    uint16_t subtype)
{
    of_wire_buffer_t *wbuf;
...
static void
of_action_ofdpa_color_based_tx_count_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_3:
...
/**
 * \defgroup of_action_ofdpa_color_based_tx_count of_action_ofdpa_color_based_tx_count
 */
 ...
 */
static inline int
of_action_ofdpa_color_based_tx_count_push_wire_values(of_action_ofdpa_color_based_tx_count_t *obj)
{

    of_action_ofdpa_color_based_tx_count_push_wire_types(obj);
...
/**
 * Create a new of_action_ofdpa_color_based_tx_count object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
of_action_ofdpa_color_based_tx_count_t *
of_action_ofdpa_color_based_tx_count_new(of_version_t version)
{
    of_action_ofdpa_color_based_tx_count_t *obj;
    int bytes;

    bytes = of_object_fixed_len[version][OF_ACTION_OFDPA_COLOR_BASED_TX_COUNT] + of_object_extra_len[version][OF_ACTION_OFDPA_COLOR_BASED_TX_COUNT];

    /* Allocate a maximum-length wire buffer assuming we'll be appending to it. */
    if ((obj = (of_action_ofdpa_color_based_tx_count_t *)of_object_new(OF_WIRE_BUFFER_MAX_LENGTH)) == NULL) {
        return NULL;
    }

    of_action_ofdpa_color_based_tx_count_init(obj, version, bytes, 0);

    if (of_action_ofdpa_color_based_tx_count_push_wire_values(obj) < 0) {
        FREE(obj);
        return NULL;
    }
...
/**
 * Initialize an object of type of_action_ofdpa_color_based_tx_count.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_action_ofdpa_color_based_tx_count_init(of_action_ofdpa_color_based_tx_count_t *obj,
    of_version_t version, int bytes, int clean_wire)
{

    LOCI_ASSERT(of_object_fixed_len[version][OF_ACTION_OFDPA_COLOR_BASED_TX_COUNT] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_ACTION_OFDPA_COLOR_BASED_TX_COUNT;

    /* Set up the object's function pointers */

    obj->wire_type_set = of_action_ofdpa_color_based_tx_count_push_wire_types;
...
/**
 * Get experimenter from an object of type of_action_ofdpa_color_based_tx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_color_based_tx_count.
 * @param experimenter Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_action_ofdpa_color_based_tx_count_experimenter_get(
    of_action_ofdpa_color_based_tx_count_t *obj,
    uint32_t *experimenter)
{
    of_wire_buffer_t *wbuf;
    ...
    LOCI_ASSERT(obj->object_id == OF_ACTION_OFDPA_COLOR_BASED_TX_COUNT);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set experimenter in an object of type of_action_ofdpa_color_based_tx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_color_based_tx_count.
 * @param experimenter The value to write into the object
 */
void
of_action_ofdpa_color_based_tx_count_experimenter_set(
    of_action_ofdpa_color_based_tx_count_t *obj,
    uint32_t experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get subtype from an object of type of_action_ofdpa_color_based_tx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_color_based_tx_count.
 * @param subtype Pointer to the child object of type
 * uint16_t to be filled out.
 *
 */
void
of_action_ofdpa_color_based_tx_count_subtype_get(
    of_action_ofdpa_color_based_tx_count_t *obj,
    uint16_t *subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set subtype in an object of type of_action_ofdpa_color_based_tx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_color_based_tx_count.
 * @param subtype The value to write into the object
 */
void
of_action_ofdpa_color_based_tx_count_subtype_set(
    of_action_ofdpa_color_based_tx_count_t *obj,
    uint16_t subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get act_color from an object of type of_action_ofdpa_color_based_tx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_color_based_tx_count.
 * @param act_color Pointer to the child object of type
 * uint16_t to be filled out.
 *
 */
void
of_action_ofdpa_color_based_tx_count_act_color_get(
    of_action_ofdpa_color_based_tx_count_t *obj,
    uint16_t *act_color)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set act_color in an object of type of_action_ofdpa_color_based_tx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_color_based_tx_count.
 * @param act_color The value to write into the object
 */
void
of_action_ofdpa_color_based_tx_count_act_color_set(
    of_action_ofdpa_color_based_tx_count_t *obj,
    uint16_t act_color)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get index from an object of type of_action_ofdpa_color_based_tx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_color_based_tx_count.
 * @param index Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_action_ofdpa_color_based_tx_count_index_get(
    of_action_ofdpa_color_based_tx_count_t *obj,
    uint32_t *index)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set index in an object of type of_action_ofdpa_color_based_tx_count.
 * @param obj Pointer to an object of type of_action_ofdpa_color_based_tx_count.
 * @param index The value to write into the object
 */
void
of_action_ofdpa_color_based_tx_count_index_set(
    of_action_ofdpa_color_based_tx_count_t *obj,
    uint32_t index)
{
    of_wire_buffer_t *wbuf;
...
static void
of_action_id_ofdpa_color_based_tx_count_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_3:
...
/**
 * \defgroup of_action_id_ofdpa_color_based_tx_count of_action_id_ofdpa_color_based_tx_count
 */
 ...
 */
static inline int
of_action_id_ofdpa_color_based_tx_count_push_wire_values(of_action_id_ofdpa_color_based_tx_count_t *obj)
{

    of_action_id_ofdpa_color_based_tx_count_push_wire_types(obj);
...
/**
 * Create a new of_action_id_ofdpa_color_based_tx_count object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
of_action_id_ofdpa_color_based_tx_count_t *
of_action_id_ofdpa_color_based_tx_count_new(of_version_t version)
{
    of_action_id_ofdpa_color_based_tx_count_t *obj;
    int bytes;

    bytes = of_object_fixed_len[version][OF_ACTION_ID_OFDPA_COLOR_BASED_TX_COUNT] + of_object_extra_len[version][OF_ACTION_ID_OFDPA_COLOR_BASED_TX_COUNT];

    /* Allocate a maximum-length wire buffer assuming we'll be appending to it. */
    if ((obj = (of_action_id_ofdpa_color_based_tx_count_t *)of_object_new(OF_WIRE_BUFFER_MAX_LENGTH)) == NULL) {
        return NULL;
    }

    of_action_id_ofdpa_color_based_tx_count_init(obj, version, bytes, 0);

    if (of_action_id_ofdpa_color_based_tx_count_push_wire_values(obj) < 0) {
        FREE(obj);
        return NULL;
    }
...
/**
 * Initialize an object of type of_action_id_ofdpa_color_based_tx_count.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_action_id_ofdpa_color_based_tx_count_init(of_action_id_ofdpa_color_based_tx_count_t *obj,
    of_version_t version, int bytes, int clean_wire)
{

    LOCI_ASSERT(of_object_fixed_len[version][OF_ACTION_ID_OFDPA_COLOR_BASED_TX_COUNT] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_ACTION_ID_OFDPA_COLOR_BASED_TX_COUNT;

    /* Set up the object's function pointers */

    obj->wire_type_set = of_action_id_ofdpa_color_based_tx_count_push_wire_types;
...
/**
 * Get experimenter from an object of type of_action_id_ofdpa_color_based_tx_count.
 * @param obj Pointer to an object of type of_action_id_ofdpa_color_based_tx_count.
 * @param experimenter Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_action_id_ofdpa_color_based_tx_count_experimenter_get(
    of_action_id_ofdpa_color_based_tx_count_t *obj,
    uint32_t *experimenter)
{
    of_wire_buffer_t *wbuf;
    ...
    LOCI_ASSERT(obj->object_id == OF_ACTION_ID_OFDPA_COLOR_BASED_TX_COUNT);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set experimenter in an object of type of_action_id_ofdpa_color_based_tx_count.
 * @param obj Pointer to an object of type of_action_id_ofdpa_color_based_tx_count.
 * @param experimenter The value to write into the object
 */
void
of_action_id_ofdpa_color_based_tx_count_experimenter_set(
    of_action_id_ofdpa_color_based_tx_count_t *obj,
    uint32_t experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get subtype from an object of type of_action_id_ofdpa_color_based_tx_count.
 * @param obj Pointer to an object of type of_action_id_ofdpa_color_based_tx_count.
 * @param subtype Pointer to the child object of type
 * uint16_t to be filled out.
 *
 */
void
of_action_id_ofdpa_color_based_tx_count_subtype_get(
    of_action_id_ofdpa_color_based_tx_count_t *obj,
    uint16_t *subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set subtype in an object of type of_action_id_ofdpa_color_based_tx_count.
 * @param obj Pointer to an object of type of_action_id_ofdpa_color_based_tx_count.
 * @param subtype The value to write into the object
 */
void
of_action_id_ofdpa_color_based_tx_count_subtype_set(
    of_action_id_ofdpa_color_based_tx_count_t *obj,
    uint16_t subtype)
{
    of_wire_buffer_t *wbuf;

...
static inline int of_oxm_ofdpa_bfd_discriminator_masked_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_oxm_ofdpa_bfd_discriminator_OF_VERSION_1_3_validate(uint8_t *buf, int len);
...
static inline int of_action_ofdpa_set_mpls_qos_from_table_OF_VERSION_1_3_validate(uint8_t *buf, int len);
...
static inline int of_action_ofdpa_color_based_tx_count_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_ofdpa_color_based_rx_count_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_ofdpa_class_based_tx_count_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_ofdpa_class_based_rx_count_OF_VERSION_1_3_validate(uint8_t *buf, int len);
...
static inline int of_action_id_ofdpa_set_mpls_qos_from_table_OF_VERSION_1_3_validate(uint8_t *buf, int len);
...
static inline int of_action_id_ofdpa_color_based_tx_count_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_id_ofdpa_color_based_rx_count_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_id_ofdpa_class_based_tx_count_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int of_action_id_ofdpa_class_based_rx_count_OF_VERSION_1_3_validate(uint8_t *buf, int len);
...
static inline int ofdpa_scheduler_node_multipart_response_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_scheduler_node_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_scheduler_node_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_queue_mod_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_queue_desc_prop_parent_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_queue_desc_prop_parent_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_queue_desc_prop_congestion_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_queue_desc_prop_congestion_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_port_experimenter_prop_scheduling_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_oam_drop_status_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_oam_drop_status_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_oam_drop_status_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_oam_dataplane_ctr_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_oam_dataplane_ctr_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_oam_dataplane_ctr_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_mpls_vpn_label_remark_action_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_mpls_vpn_label_remark_action_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_mpls_vpn_label_remark_action_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_mpls_tunnel_label_remark_action_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_mpls_tunnel_label_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_mpls_tunnel_label_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_mpls_set_qos_action_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_mpls_set_qos_action_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_mpls_set_qos_action_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_l2_interface_remark_action_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_l2_interface_remark_action_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_l2_interface_remark_action_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_color_based_ctr_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_color_based_ctr_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_color_based_ctr_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_class_based_ctr_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_class_based_ctr_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len);
static inline int ofdpa_class_based_ctr_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len);
...
of_list_action_id_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    while (len >= 4) {
        ...
        case OF_ACTION_ID_OFDPA_PUSH_L2HDR:
            ...
            break;
        case OF_ACTION_ID_OFDPA_COLOR_BASED_RX_COUNT:
            if (of_action_id_ofdpa_color_based_rx_count_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        ...
        case OF_ACTION_ID_OFDPA_POP_CW:
            ...
            break;
        case OF_ACTION_ID_OFDPA_SET_MPLS_QOS_FROM_TABLE:
            if (of_action_id_ofdpa_set_mpls_qos_from_table_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        ...
        case OF_ACTION_ID_OFDPA_OAM_LM_RX_COUNT:
            ...
            break;
        case OF_ACTION_ID_OFDPA_COLOR_BASED_TX_COUNT:
            if (of_action_id_ofdpa_color_based_tx_count_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        ...
        case OF_ACTION_ID_PUSH_MPLS:
            ...
            break;
        case OF_ACTION_ID_OFDPA_CLASS_BASED_RX_COUNT:
            if (of_action_id_ofdpa_class_based_rx_count_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_ID_DEC_NW_TTL:
            ...
            break;
        case OF_ACTION_ID_OFDPA_CLASS_BASED_TX_COUNT:
            if (of_action_id_ofdpa_class_based_tx_count_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
...
of_list_action_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    while (len >= 8) {
        ...
        case OF_ACTION_OFDPA_PUSH_L2HDR:
            ...
            break;
        case OF_ACTION_OFDPA_COLOR_BASED_RX_COUNT:
            if (of_action_ofdpa_color_based_rx_count_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        ...
        case OF_ACTION_OFDPA_POP_CW:
            ...
            break;
        case OF_ACTION_OFDPA_SET_MPLS_QOS_FROM_TABLE:
            if (of_action_ofdpa_set_mpls_qos_from_table_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        ...
        case OF_ACTION_OFDPA_OAM_LM_RX_COUNT:
            ...
            break;
        case OF_ACTION_OFDPA_COLOR_BASED_TX_COUNT:
            if (of_action_ofdpa_color_based_tx_count_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_POP_MPLS:
        ...
        case OF_ACTION_PUSH_MPLS:
            ...
            break;
        case OF_ACTION_OFDPA_CLASS_BASED_RX_COUNT:
            if (of_action_ofdpa_class_based_rx_count_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
        case OF_ACTION_DEC_NW_TTL:
            ...
            break;
        case OF_ACTION_OFDPA_CLASS_BASED_TX_COUNT:
            if (of_action_ofdpa_class_based_tx_count_OF_VERSION_1_3_validate(buf, e_len) < 0) {
                return -1;
            }
            break;
...
static inline int
of_oxm_ofdpa_bfd_discriminator_masked_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_oxm_ofdpa_bfd_discriminator_masked.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_oxm_ofdpa_bfd_discriminator_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 12) {
        VALIDATOR_LOG("Class of_oxm_ofdpa_bfd_discriminator.  Len %d too small, < %d", len, 12);
        return -1;
    }
...
static inline int
of_action_ofdpa_set_mpls_qos_from_table_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_ofdpa_set_mpls_qos_from_table.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
{
    if (len < 18) {
        VALIDATOR_LOG("Class of_action_ofdpa_set_counter_fields.  Len %d too small, < %d", len, 18);
        return -1;
    }
...
static inline int
of_action_ofdpa_color_based_tx_count_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_ofdpa_color_based_tx_count.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_action_ofdpa_color_based_rx_count_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_ofdpa_color_based_rx_count.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_action_ofdpa_class_based_tx_count_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_ofdpa_class_based_tx_count.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_action_ofdpa_class_based_rx_count_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 16) {
        VALIDATOR_LOG("Class of_action_ofdpa_class_based_rx_count.  Len %d too small, < %d", len, 16);
        return -1;
    }
...
static inline int
of_action_id_ofdpa_set_mpls_qos_from_table_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_ofdpa_set_mpls_qos_from_table.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_action_id_ofdpa_color_based_tx_count_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_ofdpa_color_based_tx_count.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_action_id_ofdpa_color_based_rx_count_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_ofdpa_color_based_rx_count.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_action_id_ofdpa_class_based_tx_count_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_ofdpa_class_based_tx_count.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
of_action_id_ofdpa_class_based_rx_count_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 10) {
        VALIDATOR_LOG("Class of_action_id_ofdpa_class_based_rx_count.  Len %d too small, < %d", len, 10);
        return -1;
    }
...
static inline int
ofdpa_scheduler_node_multipart_response_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 40) {
        VALIDATOR_LOG("Class ofdpa_scheduler_node_multipart_response.  Len %d too small, < %d", len, 40);
        return -1;
    }
...
static inline int
ofdpa_scheduler_node_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 40) {
        VALIDATOR_LOG("Class ofdpa_scheduler_node_multipart_request.  Len %d too small, < %d", len, 40);
        return -1;
    }
...
static inline int
ofdpa_scheduler_node_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 34) {
        VALIDATOR_LOG("Class ofdpa_scheduler_node_mod_msg.  Len %d too small, < %d", len, 34);
        return -1;
    }
...
static inline int
ofdpa_queue_mod_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 42) {
        VALIDATOR_LOG("Class ofdpa_queue_mod.  Len %d too small, < %d", len, 42);
        return -1;
    }
...
static inline int
ofdpa_queue_desc_prop_parent_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 28) {
        VALIDATOR_LOG("Class ofdpa_queue_desc_prop_parent_multipart_request.  Len %d too small, < %d", len, 28);
        return -1;
    }
...
static inline int
ofdpa_queue_desc_prop_parent_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 28) {
        VALIDATOR_LOG("Class ofdpa_queue_desc_prop_parent_multipart_reply.  Len %d too small, < %d", len, 28);
        return -1;
    }
...
static inline int
ofdpa_queue_desc_prop_congestion_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 28) {
        VALIDATOR_LOG("Class ofdpa_queue_desc_prop_congestion_multipart_request.  Len %d too small, < %d", len, 28);
        return -1;
    }
...
static inline int
ofdpa_queue_desc_prop_congestion_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 28) {
        VALIDATOR_LOG("Class ofdpa_queue_desc_prop_congestion_multipart_reply.  Len %d too small, < %d", len, 28);
        return -1;
    }
...
static inline int
ofdpa_port_experimenter_prop_scheduling_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 48) {
        VALIDATOR_LOG("Class ofdpa_port_experimenter_prop_scheduling.  Len %d too small, < %d", len, 48);
        return -1;
    }
...
static inline int
ofdpa_oam_drop_status_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 35) {
        VALIDATOR_LOG("Class ofdpa_oam_drop_status_multipart_request.  Len %d too small, < %d", len, 35);
        return -1;
    }
...
static inline int
ofdpa_oam_drop_status_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 31) {
        VALIDATOR_LOG("Class ofdpa_oam_drop_status_multipart_reply.  Len %d too small, < %d", len, 31);
        return -1;
    }
...
static inline int
ofdpa_oam_drop_status_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 32) {
        VALIDATOR_LOG("Class ofdpa_oam_drop_status_mod_msg.  Len %d too small, < %d", len, 32);
        return -1;
    }
...
static inline int
ofdpa_oam_dataplane_ctr_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 56) {
        VALIDATOR_LOG("Class ofdpa_oam_dataplane_ctr_multipart_request.  Len %d too small, < %d", len, 56);
        return -1;
    }
...
static inline int
ofdpa_oam_dataplane_ctr_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 56) {
        VALIDATOR_LOG("Class ofdpa_oam_dataplane_ctr_multipart_reply.  Len %d too small, < %d", len, 56);
        return -1;
    }
...
static inline int
ofdpa_oam_dataplane_ctr_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 48) {
        VALIDATOR_LOG("Class ofdpa_oam_dataplane_ctr_mod_msg.  Len %d too small, < %d", len, 48);
        return -1;
    }
...
static inline int
ofdpa_mpls_vpn_label_remark_action_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 39) {
        VALIDATOR_LOG("Class ofdpa_mpls_vpn_label_remark_action_multipart_request.  Len %d too small, < %d", len, 39);
        return -1;
    }
...
static inline int
ofdpa_mpls_vpn_label_remark_action_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 39) {
        VALIDATOR_LOG("Class ofdpa_mpls_vpn_label_remark_action_multipart_reply.  Len %d too small, < %d", len, 39);
        return -1;
    }
...
static inline int
ofdpa_mpls_vpn_label_remark_action_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 32) {
        VALIDATOR_LOG("Class ofdpa_mpls_vpn_label_remark_action_mod_msg.  Len %d too small, < %d", len, 32);
        return -1;
    }
...
static inline int
ofdpa_mpls_tunnel_label_remark_action_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 32) {
        VALIDATOR_LOG("Class ofdpa_mpls_tunnel_label_remark_action_mod_msg.  Len %d too small, < %d", len, 32);
        return -1;
    }
...
static inline int
ofdpa_mpls_tunnel_label_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 39) {
        VALIDATOR_LOG("Class ofdpa_mpls_tunnel_label_multipart_request.  Len %d too small, < %d", len, 39);
        return -1;
    }
...
static inline int
ofdpa_mpls_tunnel_label_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 39) {
        VALIDATOR_LOG("Class ofdpa_mpls_tunnel_label_multipart_reply.  Len %d too small, < %d", len, 39);
        return -1;
    }
...
static inline int
ofdpa_mpls_set_qos_action_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 32) {
        VALIDATOR_LOG("Class ofdpa_mpls_set_qos_action_multipart_request.  Len %d too small, < %d", len, 32);
        return -1;
    }
...
static inline int
ofdpa_mpls_set_qos_action_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 32) {
        VALIDATOR_LOG("Class ofdpa_mpls_set_qos_action_multipart_reply.  Len %d too small, < %d", len, 32);
        return -1;
    }
...
static inline int
ofdpa_mpls_set_qos_action_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 24) {
        VALIDATOR_LOG("Class ofdpa_mpls_set_qos_action_mod_msg.  Len %d too small, < %d", len, 24);
        return -1;
    }
...
static inline int
ofdpa_l2_interface_remark_action_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 39) {
        VALIDATOR_LOG("Class ofdpa_l2_interface_remark_action_multipart_request.  Len %d too small, < %d", len, 39);
        return -1;
    }
...
static inline int
ofdpa_l2_interface_remark_action_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 39) {
        VALIDATOR_LOG("Class ofdpa_l2_interface_remark_action_multipart_reply.  Len %d too small, < %d", len, 39);
        return -1;
    }
...
static inline int
ofdpa_l2_interface_remark_action_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 32) {
        VALIDATOR_LOG("Class ofdpa_l2_interface_remark_action_mod_msg.  Len %d too small, < %d", len, 32);
        return -1;
    }
...
static inline int
ofdpa_color_based_ctr_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 44) {
        VALIDATOR_LOG("Class ofdpa_color_based_ctr_multipart_request.  Len %d too small, < %d", len, 44);
        return -1;
    }
...
static inline int
ofdpa_color_based_ctr_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 44) {
        VALIDATOR_LOG("Class ofdpa_color_based_ctr_multipart_reply.  Len %d too small, < %d", len, 44);
        return -1;
    }
...
static inline int
ofdpa_color_based_ctr_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 48) {
        VALIDATOR_LOG("Class ofdpa_color_based_ctr_mod_msg.  Len %d too small, < %d", len, 48);
        return -1;
    }
...
static inline int
ofdpa_class_based_ctr_multipart_request_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 24) {
        VALIDATOR_LOG("Class ofdpa_class_based_ctr_multipart_request.  Len %d too small, < %d", len, 24);
        return -1;
    }
...
static inline int
ofdpa_class_based_ctr_multipart_reply_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 48) {
        VALIDATOR_LOG("Class ofdpa_class_based_ctr_multipart_reply.  Len %d too small, < %d", len, 48);
        return -1;
    }
...
static inline int
ofdpa_class_based_ctr_mod_msg_OF_VERSION_1_3_validate(uint8_t *buf, int len)
{
    if (len < 47) {
        VALIDATOR_LOG("Class ofdpa_class_based_ctr_mod_msg.  Len %d too small, < %d", len, 47);
        return -1;
    }
...
of_validate_message_OF_VERSION_1_3(of_message_t msg, int len)
{
    ...
    uint8_t *buf = OF_MESSAGE_TO_BUFFER(msg);
    switch (object_id) {
    case OFDPA_SCHEDULER_NODE_MULTIPART_RESPONSE:
        return ofdpa_scheduler_node_multipart_response_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_SCHEDULER_NODE_MULTIPART_REQUEST:
        return ofdpa_scheduler_node_multipart_request_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_SCHEDULER_NODE_MOD_MSG:
        return ofdpa_scheduler_node_mod_msg_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_QUEUE_MOD:
        return ofdpa_queue_mod_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_QUEUE_DESC_PROP_PARENT_MULTIPART_REQUEST:
        return ofdpa_queue_desc_prop_parent_multipart_request_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_QUEUE_DESC_PROP_PARENT_MULTIPART_REPLY:
        return ofdpa_queue_desc_prop_parent_multipart_reply_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_QUEUE_DESC_PROP_CONGESTION_MULTIPART_REQUEST:
        return ofdpa_queue_desc_prop_congestion_multipart_request_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_QUEUE_DESC_PROP_CONGESTION_MULTIPART_REPLY:
        return ofdpa_queue_desc_prop_congestion_multipart_reply_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_PORT_EXPERIMENTER_PROP_SCHEDULING:
        return ofdpa_port_experimenter_prop_scheduling_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_OAM_DROP_STATUS_MULTIPART_REQUEST:
        return ofdpa_oam_drop_status_multipart_request_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_OAM_DROP_STATUS_MULTIPART_REPLY:
        return ofdpa_oam_drop_status_multipart_reply_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_OAM_DROP_STATUS_MOD_MSG:
        return ofdpa_oam_drop_status_mod_msg_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_OAM_DATAPLANE_CTR_MULTIPART_REQUEST:
        return ofdpa_oam_dataplane_ctr_multipart_request_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_OAM_DATAPLANE_CTR_MULTIPART_REPLY:
        return ofdpa_oam_dataplane_ctr_multipart_reply_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_OAM_DATAPLANE_CTR_MOD_MSG:
        return ofdpa_oam_dataplane_ctr_mod_msg_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_MPLS_VPN_LABEL_REMARK_ACTION_MULTIPART_REQUEST:
        return ofdpa_mpls_vpn_label_remark_action_multipart_request_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_MPLS_VPN_LABEL_REMARK_ACTION_MULTIPART_REPLY:
        return ofdpa_mpls_vpn_label_remark_action_multipart_reply_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_MPLS_VPN_LABEL_REMARK_ACTION_MOD_MSG:
        return ofdpa_mpls_vpn_label_remark_action_mod_msg_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_MPLS_TUNNEL_LABEL_REMARK_ACTION_MOD_MSG:
        return ofdpa_mpls_tunnel_label_remark_action_mod_msg_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_MPLS_TUNNEL_LABEL_MULTIPART_REQUEST:
        return ofdpa_mpls_tunnel_label_multipart_request_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_MPLS_TUNNEL_LABEL_MULTIPART_REPLY:
        return ofdpa_mpls_tunnel_label_multipart_reply_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_MPLS_SET_QOS_ACTION_MULTIPART_REQUEST:
        return ofdpa_mpls_set_qos_action_multipart_request_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_MPLS_SET_QOS_ACTION_MULTIPART_REPLY:
        return ofdpa_mpls_set_qos_action_multipart_reply_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_MPLS_SET_QOS_ACTION_MOD_MSG:
        return ofdpa_mpls_set_qos_action_mod_msg_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_L2_INTERFACE_REMARK_ACTION_MULTIPART_REQUEST:
        return ofdpa_l2_interface_remark_action_multipart_request_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_L2_INTERFACE_REMARK_ACTION_MULTIPART_REPLY:
        return ofdpa_l2_interface_remark_action_multipart_reply_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_L2_INTERFACE_REMARK_ACTION_MOD_MSG:
        return ofdpa_l2_interface_remark_action_mod_msg_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_COLOR_BASED_CTR_MULTIPART_REQUEST:
        return ofdpa_color_based_ctr_multipart_request_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_COLOR_BASED_CTR_MULTIPART_REPLY:
        return ofdpa_color_based_ctr_multipart_reply_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_COLOR_BASED_CTR_MOD_MSG:
        return ofdpa_color_based_ctr_mod_msg_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_CLASS_BASED_CTR_MULTIPART_REQUEST:
        return ofdpa_class_based_ctr_multipart_request_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_CLASS_BASED_CTR_MULTIPART_REPLY:
        return ofdpa_class_based_ctr_multipart_reply_OF_VERSION_1_3_validate(buf, len);
    case OFDPA_CLASS_BASED_CTR_MOD_MSG:
        return ofdpa_class_based_ctr_mod_msg_OF_VERSION_1_3_validate(buf, len);
    case OF_TABLE_STATS_REQUEST:

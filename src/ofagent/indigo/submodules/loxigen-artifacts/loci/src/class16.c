...
of_oxm_onf_actset_output_push_wire_types(of_object_t *obj)
{
    ...
    switch (obj->version) {
    case OF_VERSION_1_3:
        *(uint32_t *)(buf + 0) = U32_HTON(0xffff5608); /* type_len */
...
static void
ofdpa_class_based_ctr_mod_msg_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_3:
...
/**
 * \defgroup ofdpa_class_based_ctr_mod_msg ofdpa_class_based_ctr_mod_msg
 */
 ...
 */
static inline int
ofdpa_class_based_ctr_mod_msg_push_wire_values(ofdpa_class_based_ctr_mod_msg_t *obj)
{

    ofdpa_class_based_ctr_mod_msg_push_wire_types(obj);
...
/**
 * Create a new ofdpa_class_based_ctr_mod_msg object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
ofdpa_class_based_ctr_mod_msg_t *
ofdpa_class_based_ctr_mod_msg_new(of_version_t version)
{
    ofdpa_class_based_ctr_mod_msg_t *obj;
    int bytes;

    bytes = of_object_fixed_len[version][OFDPA_CLASS_BASED_CTR_MOD_MSG] + of_object_extra_len[version][OFDPA_CLASS_BASED_CTR_MOD_MSG];

    /* Allocate a maximum-length wire buffer assuming we'll be appending to it. */
    if ((obj = (ofdpa_class_based_ctr_mod_msg_t *)of_object_new(OF_WIRE_BUFFER_MAX_LENGTH)) == NULL) {
        return NULL;
    }

    ofdpa_class_based_ctr_mod_msg_init(obj, version, bytes, 0);

    if (ofdpa_class_based_ctr_mod_msg_push_wire_values(obj) < 0) {
        FREE(obj);
        return NULL;
    }
...
/**
 * Initialize an object of type ofdpa_class_based_ctr_mod_msg.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
ofdpa_class_based_ctr_mod_msg_init(ofdpa_class_based_ctr_mod_msg_t *obj,
    of_version_t version, int bytes, int clean_wire)
{

    LOCI_ASSERT(of_object_fixed_len[version][OFDPA_CLASS_BASED_CTR_MOD_MSG] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OFDPA_CLASS_BASED_CTR_MOD_MSG;

    /* Set up the object's function pointers */

    obj->wire_type_set = ofdpa_class_based_ctr_mod_msg_push_wire_types;
...
/**
 * Create a new ofdpa_class_based_ctr_mod_msg object and bind it to an existing message
 *
 * @param msg The message to bind the new object to
 * @return Pointer to the newly create object or NULL on error
 *
...
{
    ofdpa_class_based_ctr_mod_msg_t *obj = NULL;
    of_version_t version;
    int length;
    ...
    if ((obj = (ofdpa_class_based_ctr_mod_msg_t *)of_object_new(-1)) == NULL) {
        return NULL;
    }

    ofdpa_class_based_ctr_mod_msg_init(obj, version, 0, 0);
...
/**
 * Get xid from an object of type ofdpa_class_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_mod_msg.
 * @param xid Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
ofdpa_class_based_ctr_mod_msg_xid_get(
    ofdpa_class_based_ctr_mod_msg_t *obj,
    uint32_t *xid)
{
    of_wire_buffer_t *wbuf;
    ...
    LOCI_ASSERT(obj->object_id == OFDPA_CLASS_BASED_CTR_MOD_MSG);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set xid in an object of type ofdpa_class_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_mod_msg.
 * @param xid The value to write into the object
 */
void
ofdpa_class_based_ctr_mod_msg_xid_set(
    ofdpa_class_based_ctr_mod_msg_t *obj,
    uint32_t xid)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get experimenter from an object of type ofdpa_class_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_mod_msg.
 * @param experimenter Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
ofdpa_class_based_ctr_mod_msg_experimenter_get(
    ofdpa_class_based_ctr_mod_msg_t *obj,
    uint32_t *experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set experimenter in an object of type ofdpa_class_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_mod_msg.
 * @param experimenter The value to write into the object
 */
void
ofdpa_class_based_ctr_mod_msg_experimenter_set(
    ofdpa_class_based_ctr_mod_msg_t *obj,
    uint32_t experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get subtype from an object of type ofdpa_class_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_mod_msg.
 * @param subtype Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
ofdpa_class_based_ctr_mod_msg_subtype_get(
    ofdpa_class_based_ctr_mod_msg_t *obj,
    uint32_t *subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set subtype in an object of type ofdpa_class_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_mod_msg.
 * @param subtype The value to write into the object
 */
void
ofdpa_class_based_ctr_mod_msg_subtype_set(
    ofdpa_class_based_ctr_mod_msg_t *obj,
    uint32_t subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get mod_command from an object of type ofdpa_class_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_mod_msg.
 ...
 */
void
ofdpa_class_based_ctr_mod_msg_mod_command_get(
    ofdpa_class_based_ctr_mod_msg_t *obj,
...
/**
 * Set mod_command in an object of type ofdpa_class_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_mod_msg.
 * @param mod_command The value to write into the object
 */
void
ofdpa_class_based_ctr_mod_msg_mod_command_set(
    ofdpa_class_based_ctr_mod_msg_t *obj,
    uint32_t mod_command)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get block_index from an object of type ofdpa_class_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_mod_msg.
 ...
 */
void
ofdpa_class_based_ctr_mod_msg_block_index_get(
    ofdpa_class_based_ctr_mod_msg_t *obj,
...
/**
 * Set block_index in an object of type ofdpa_class_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_mod_msg.
 * @param block_index The value to write into the object
 */
void
ofdpa_class_based_ctr_mod_msg_block_index_set(
    ofdpa_class_based_ctr_mod_msg_t *obj,
    uint32_t block_index)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get transmit_packets from an object of type ofdpa_class_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_mod_msg.
 ...
 */
void
ofdpa_class_based_ctr_mod_msg_transmit_packets_get(
    ofdpa_class_based_ctr_mod_msg_t *obj,
...
/**
 * Set transmit_packets in an object of type ofdpa_class_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_mod_msg.
 * @param transmit_packets The value to write into the object
 */
void
ofdpa_class_based_ctr_mod_msg_transmit_packets_set(
    ofdpa_class_based_ctr_mod_msg_t *obj,
    uint64_t transmit_packets)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get receive_packets from an object of type ofdpa_class_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_mod_msg.
 ...
 */
void
ofdpa_class_based_ctr_mod_msg_receive_packets_get(
    ofdpa_class_based_ctr_mod_msg_t *obj,
...
/**
 * Set receive_packets in an object of type ofdpa_class_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_mod_msg.
 * @param receive_packets The value to write into the object
 */
void
ofdpa_class_based_ctr_mod_msg_receive_packets_set(
    ofdpa_class_based_ctr_mod_msg_t *obj,
    uint64_t receive_packets)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get traffic_class from an object of type ofdpa_class_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_mod_msg.
 ...
 */
void
ofdpa_class_based_ctr_mod_msg_traffic_class_get(
    ofdpa_class_based_ctr_mod_msg_t *obj,
...
/**
 * Set traffic_class in an object of type ofdpa_class_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_mod_msg.
 * @param traffic_class The value to write into the object
 */
void
ofdpa_class_based_ctr_mod_msg_traffic_class_set(
    ofdpa_class_based_ctr_mod_msg_t *obj,
    uint8_t traffic_class)
{
    of_wire_buffer_t *wbuf;
...
static void
ofdpa_class_based_ctr_multipart_reply_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_3:
...
/**
 * \defgroup ofdpa_class_based_ctr_multipart_reply ofdpa_class_based_ctr_multipart_reply
 */
 ...
 */
static inline int
ofdpa_class_based_ctr_multipart_reply_push_wire_values(ofdpa_class_based_ctr_multipart_reply_t *obj)
{

    ofdpa_class_based_ctr_multipart_reply_push_wire_types(obj);
...
/**
 * Create a new ofdpa_class_based_ctr_multipart_reply object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
ofdpa_class_based_ctr_multipart_reply_t *
ofdpa_class_based_ctr_multipart_reply_new(of_version_t version)
{
    ofdpa_class_based_ctr_multipart_reply_t *obj;
    int bytes;

    bytes = of_object_fixed_len[version][OFDPA_CLASS_BASED_CTR_MULTIPART_REPLY] + of_object_extra_len[version][OFDPA_CLASS_BASED_CTR_MULTIPART_REPLY];

    /* Allocate a maximum-length wire buffer assuming we'll be appending to it. */
    if ((obj = (ofdpa_class_based_ctr_multipart_reply_t *)of_object_new(OF_WIRE_BUFFER_MAX_LENGTH)) == NULL) {
        return NULL;
    }

    ofdpa_class_based_ctr_multipart_reply_init(obj, version, bytes, 0);

    if (ofdpa_class_based_ctr_multipart_reply_push_wire_values(obj) < 0) {
        FREE(obj);
        return NULL;
    }
...
/**
 * Initialize an object of type ofdpa_class_based_ctr_multipart_reply.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
ofdpa_class_based_ctr_multipart_reply_init(ofdpa_class_based_ctr_multipart_reply_t *obj,
    of_version_t version, int bytes, int clean_wire)
{

    LOCI_ASSERT(of_object_fixed_len[version][OFDPA_CLASS_BASED_CTR_MULTIPART_REPLY] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OFDPA_CLASS_BASED_CTR_MULTIPART_REPLY;

    /* Set up the object's function pointers */

    obj->wire_type_set = ofdpa_class_based_ctr_multipart_reply_push_wire_types;
...
/**
 * Create a new ofdpa_class_based_ctr_multipart_reply object and bind it to an existing message
 *
 * @param msg The message to bind the new object to
 * @return Pointer to the newly create object or NULL on error
 *
...
{
    ofdpa_class_based_ctr_multipart_reply_t *obj = NULL;
    of_version_t version;
    int length;
    ...
    if ((obj = (ofdpa_class_based_ctr_multipart_reply_t *)of_object_new(-1)) == NULL) {
        return NULL;
    }

    ofdpa_class_based_ctr_multipart_reply_init(obj, version, 0, 0);
...
/**
 * Get xid from an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param xid Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
ofdpa_class_based_ctr_multipart_reply_xid_get(
    ofdpa_class_based_ctr_multipart_reply_t *obj,
    uint32_t *xid)
{
    of_wire_buffer_t *wbuf;
    ...
    LOCI_ASSERT(obj->object_id == OFDPA_CLASS_BASED_CTR_MULTIPART_REPLY);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set xid in an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param xid The value to write into the object
 */
void
ofdpa_class_based_ctr_multipart_reply_xid_set(
    ofdpa_class_based_ctr_multipart_reply_t *obj,
    uint32_t xid)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get experimenter from an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param experimenter Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
ofdpa_class_based_ctr_multipart_reply_experimenter_get(
    ofdpa_class_based_ctr_multipart_reply_t *obj,
    uint32_t *experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set experimenter in an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param experimenter The value to write into the object
 */
void
ofdpa_class_based_ctr_multipart_reply_experimenter_set(
    ofdpa_class_based_ctr_multipart_reply_t *obj,
    uint32_t experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get subtype from an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param subtype Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
ofdpa_class_based_ctr_multipart_reply_subtype_get(
    ofdpa_class_based_ctr_multipart_reply_t *obj,
    uint32_t *subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set subtype in an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param subtype The value to write into the object
 */
void
ofdpa_class_based_ctr_multipart_reply_subtype_set(
    ofdpa_class_based_ctr_multipart_reply_t *obj,
    uint32_t subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get block_index from an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param block_index Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
ofdpa_class_based_ctr_multipart_reply_block_index_get(
    ofdpa_class_based_ctr_multipart_reply_t *obj,
    uint32_t *block_index)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set block_index in an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param block_index The value to write into the object
 */
void
ofdpa_class_based_ctr_multipart_reply_block_index_set(
    ofdpa_class_based_ctr_multipart_reply_t *obj,
    uint32_t block_index)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get transmit_packets from an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param transmit_packets Pointer to the child object of type
 * uint64_t to be filled out.
 *
 */
void
ofdpa_class_based_ctr_multipart_reply_transmit_packets_get(
    ofdpa_class_based_ctr_multipart_reply_t *obj,
    uint64_t *transmit_packets)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set transmit_packets in an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param transmit_packets The value to write into the object
 */
void
ofdpa_class_based_ctr_multipart_reply_transmit_packets_set(
    ofdpa_class_based_ctr_multipart_reply_t *obj,
    uint64_t transmit_packets)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get receive_packets from an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param receive_packets Pointer to the child object of type
 * uint64_t to be filled out.
 *
 */
void
ofdpa_class_based_ctr_multipart_reply_receive_packets_get(
    ofdpa_class_based_ctr_multipart_reply_t *obj,
    uint64_t *receive_packets)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set receive_packets in an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param receive_packets The value to write into the object
 */
void
ofdpa_class_based_ctr_multipart_reply_receive_packets_set(
    ofdpa_class_based_ctr_multipart_reply_t *obj,
    uint64_t receive_packets)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get reference_count from an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_multipart_reply.
 ...
 */
void
ofdpa_class_based_ctr_multipart_reply_reference_count_get(
    ofdpa_class_based_ctr_multipart_reply_t *obj,
...
/**
 * Set reference_count in an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param reference_count The value to write into the object
 */
void
ofdpa_class_based_ctr_multipart_reply_reference_count_set(
    ofdpa_class_based_ctr_multipart_reply_t *obj,
    uint64_t reference_count)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get traffic_class from an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param traffic_class Pointer to the child object of type
 * uint8_t to be filled out.
 *
 */
void
ofdpa_class_based_ctr_multipart_reply_traffic_class_get(
    ofdpa_class_based_ctr_multipart_reply_t *obj,
    uint8_t *traffic_class)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set traffic_class in an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_multipart_reply.
 * @param traffic_class The value to write into the object
 */
void
ofdpa_class_based_ctr_multipart_reply_traffic_class_set(
    ofdpa_class_based_ctr_multipart_reply_t *obj,
    uint8_t traffic_class)
{
    of_wire_buffer_t *wbuf;
...
static void
ofdpa_class_based_ctr_multipart_request_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_3:
...
/**
 * \defgroup ofdpa_class_based_ctr_multipart_request ofdpa_class_based_ctr_multipart_request
 */
 ...
 */
static inline int
ofdpa_class_based_ctr_multipart_request_push_wire_values(ofdpa_class_based_ctr_multipart_request_t *obj)
{

    ofdpa_class_based_ctr_multipart_request_push_wire_types(obj);
...
/**
 * Create a new ofdpa_class_based_ctr_multipart_request object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
ofdpa_class_based_ctr_multipart_request_t *
ofdpa_class_based_ctr_multipart_request_new(of_version_t version)
{
    ofdpa_class_based_ctr_multipart_request_t *obj;
    int bytes;

    bytes = of_object_fixed_len[version][OFDPA_CLASS_BASED_CTR_MULTIPART_REQUEST] + of_object_extra_len[version][OFDPA_CLASS_BASED_CTR_MULTIPART_REQUEST];

    /* Allocate a maximum-length wire buffer assuming we'll be appending to it. */
    if ((obj = (ofdpa_class_based_ctr_multipart_request_t *)of_object_new(OF_WIRE_BUFFER_MAX_LENGTH)) == NULL) {
        return NULL;
    }

    ofdpa_class_based_ctr_multipart_request_init(obj, version, bytes, 0);

    if (ofdpa_class_based_ctr_multipart_request_push_wire_values(obj) < 0) {
        FREE(obj);
        return NULL;
    }
...
/**
 * Initialize an object of type ofdpa_class_based_ctr_multipart_request.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
ofdpa_class_based_ctr_multipart_request_init(ofdpa_class_based_ctr_multipart_request_t *obj,
    of_version_t version, int bytes, int clean_wire)
{

    LOCI_ASSERT(of_object_fixed_len[version][OFDPA_CLASS_BASED_CTR_MULTIPART_REQUEST] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OFDPA_CLASS_BASED_CTR_MULTIPART_REQUEST;

    /* Set up the object's function pointers */

    obj->wire_type_set = ofdpa_class_based_ctr_multipart_request_push_wire_types;
...
/**
 * Create a new ofdpa_class_based_ctr_multipart_request object and bind it to an existing message
 *
 * @param msg The message to bind the new object to
 * @return Pointer to the newly create object or NULL on error
 *
...
{
    ofdpa_class_based_ctr_multipart_request_t *obj = NULL;
    of_version_t version;
    int length;
    ...
    if ((obj = (ofdpa_class_based_ctr_multipart_request_t *)of_object_new(-1)) == NULL) {
        return NULL;
    }

    ofdpa_class_based_ctr_multipart_request_init(obj, version, 0, 0);
...
/**
 * Get xid from an object of type ofdpa_class_based_ctr_multipart_request.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_multipart_request.
 * @param xid Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
ofdpa_class_based_ctr_multipart_request_xid_get(
    ofdpa_class_based_ctr_multipart_request_t *obj,
    uint32_t *xid)
{
    of_wire_buffer_t *wbuf;
    ...
    LOCI_ASSERT(obj->object_id == OFDPA_CLASS_BASED_CTR_MULTIPART_REQUEST);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set xid in an object of type ofdpa_class_based_ctr_multipart_request.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_multipart_request.
 * @param xid The value to write into the object
 */
void
ofdpa_class_based_ctr_multipart_request_xid_set(
    ofdpa_class_based_ctr_multipart_request_t *obj,
    uint32_t xid)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get experimenter from an object of type ofdpa_class_based_ctr_multipart_request.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_multipart_request.
 * @param experimenter Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
ofdpa_class_based_ctr_multipart_request_experimenter_get(
    ofdpa_class_based_ctr_multipart_request_t *obj,
    uint32_t *experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set experimenter in an object of type ofdpa_class_based_ctr_multipart_request.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_multipart_request.
 * @param experimenter The value to write into the object
 */
void
ofdpa_class_based_ctr_multipart_request_experimenter_set(
    ofdpa_class_based_ctr_multipart_request_t *obj,
    uint32_t experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get subtype from an object of type ofdpa_class_based_ctr_multipart_request.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_multipart_request.
 * @param subtype Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
ofdpa_class_based_ctr_multipart_request_subtype_get(
    ofdpa_class_based_ctr_multipart_request_t *obj,
    uint32_t *subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set subtype in an object of type ofdpa_class_based_ctr_multipart_request.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_multipart_request.
 * @param subtype The value to write into the object
 */
void
ofdpa_class_based_ctr_multipart_request_subtype_set(
    ofdpa_class_based_ctr_multipart_request_t *obj,
    uint32_t subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get block_index from an object of type ofdpa_class_based_ctr_multipart_request.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_multipart_request.
 * @param block_index Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
ofdpa_class_based_ctr_multipart_request_block_index_get(
    ofdpa_class_based_ctr_multipart_request_t *obj,
    uint32_t *block_index)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set block_index in an object of type ofdpa_class_based_ctr_multipart_request.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_multipart_request.
 * @param block_index The value to write into the object
 */
void
ofdpa_class_based_ctr_multipart_request_block_index_set(
    ofdpa_class_based_ctr_multipart_request_t *obj,
    uint32_t block_index)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get traffic_class from an object of type ofdpa_class_based_ctr_multipart_request.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_multipart_request.
 * @param traffic_class Pointer to the child object of type
 * uint8_t to be filled out.
 *
 */
void
ofdpa_class_based_ctr_multipart_request_traffic_class_get(
    ofdpa_class_based_ctr_multipart_request_t *obj,
    uint8_t *traffic_class)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set traffic_class in an object of type ofdpa_class_based_ctr_multipart_request.
 * @param obj Pointer to an object of type ofdpa_class_based_ctr_multipart_request.
 * @param traffic_class The value to write into the object
 */
void
ofdpa_class_based_ctr_multipart_request_traffic_class_set(
    ofdpa_class_based_ctr_multipart_request_t *obj,
    uint8_t traffic_class)
{
    of_wire_buffer_t *wbuf;
...
static void
ofdpa_color_based_ctr_mod_msg_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_3:
...
/**
 * \defgroup ofdpa_color_based_ctr_mod_msg ofdpa_color_based_ctr_mod_msg
 */
 ...
 */
static inline int
ofdpa_color_based_ctr_mod_msg_push_wire_values(ofdpa_color_based_ctr_mod_msg_t *obj)
{

    ofdpa_color_based_ctr_mod_msg_push_wire_types(obj);
...
/**
 * Create a new ofdpa_color_based_ctr_mod_msg object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
ofdpa_color_based_ctr_mod_msg_t *
ofdpa_color_based_ctr_mod_msg_new(of_version_t version)
{
    ofdpa_color_based_ctr_mod_msg_t *obj;
    int bytes;

    bytes = of_object_fixed_len[version][OFDPA_COLOR_BASED_CTR_MOD_MSG] + of_object_extra_len[version][OFDPA_COLOR_BASED_CTR_MOD_MSG];

    /* Allocate a maximum-length wire buffer assuming we'll be appending to it. */
    if ((obj = (ofdpa_color_based_ctr_mod_msg_t *)of_object_new(OF_WIRE_BUFFER_MAX_LENGTH)) == NULL) {
        return NULL;
    }

    ofdpa_color_based_ctr_mod_msg_init(obj, version, bytes, 0);

    if (ofdpa_color_based_ctr_mod_msg_push_wire_values(obj) < 0) {
        FREE(obj);
        return NULL;
    }
...
/**
 * Initialize an object of type ofdpa_color_based_ctr_mod_msg.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
ofdpa_color_based_ctr_mod_msg_init(ofdpa_color_based_ctr_mod_msg_t *obj,
    of_version_t version, int bytes, int clean_wire)
{

    LOCI_ASSERT(of_object_fixed_len[version][OFDPA_COLOR_BASED_CTR_MOD_MSG] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OFDPA_COLOR_BASED_CTR_MOD_MSG;

    /* Set up the object's function pointers */

    obj->wire_type_set = ofdpa_color_based_ctr_mod_msg_push_wire_types;
...
/**
 * Create a new ofdpa_color_based_ctr_mod_msg object and bind it to an existing message
 *
 * @param msg The message to bind the new object to
 * @return Pointer to the newly create object or NULL on error
 *
...
{
    ofdpa_color_based_ctr_mod_msg_t *obj = NULL;
    of_version_t version;
    int length;
    ...
    if ((obj = (ofdpa_color_based_ctr_mod_msg_t *)of_object_new(-1)) == NULL) {
        return NULL;
    }

    ofdpa_color_based_ctr_mod_msg_init(obj, version, 0, 0);
...
/**
 * Get xid from an object of type ofdpa_color_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_mod_msg.
 * @param xid Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
ofdpa_color_based_ctr_mod_msg_xid_get(
    ofdpa_color_based_ctr_mod_msg_t *obj,
    uint32_t *xid)
{
    of_wire_buffer_t *wbuf;
    ...
    LOCI_ASSERT(obj->object_id == OFDPA_COLOR_BASED_CTR_MOD_MSG);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set xid in an object of type ofdpa_color_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_mod_msg.
 * @param xid The value to write into the object
 */
void
ofdpa_color_based_ctr_mod_msg_xid_set(
    ofdpa_color_based_ctr_mod_msg_t *obj,
    uint32_t xid)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get experimenter from an object of type ofdpa_color_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_mod_msg.
 * @param experimenter Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
ofdpa_color_based_ctr_mod_msg_experimenter_get(
    ofdpa_color_based_ctr_mod_msg_t *obj,
    uint32_t *experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set experimenter in an object of type ofdpa_color_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_mod_msg.
 * @param experimenter The value to write into the object
 */
void
ofdpa_color_based_ctr_mod_msg_experimenter_set(
    ofdpa_color_based_ctr_mod_msg_t *obj,
    uint32_t experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get subtype from an object of type ofdpa_color_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_mod_msg.
 * @param subtype Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
ofdpa_color_based_ctr_mod_msg_subtype_get(
    ofdpa_color_based_ctr_mod_msg_t *obj,
    uint32_t *subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set subtype in an object of type ofdpa_color_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_mod_msg.
 * @param subtype The value to write into the object
 */
void
ofdpa_color_based_ctr_mod_msg_subtype_set(
    ofdpa_color_based_ctr_mod_msg_t *obj,
    uint32_t subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get mod_command from an object of type ofdpa_color_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_mod_msg.
 * @param mod_command Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
ofdpa_color_based_ctr_mod_msg_mod_command_get(
    ofdpa_color_based_ctr_mod_msg_t *obj,
    uint32_t *mod_command)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set mod_command in an object of type ofdpa_color_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_mod_msg.
 * @param mod_command The value to write into the object
 */
void
ofdpa_color_based_ctr_mod_msg_mod_command_set(
    ofdpa_color_based_ctr_mod_msg_t *obj,
    uint32_t mod_command)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get block_index from an object of type ofdpa_color_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_mod_msg.
 * @param block_index Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
ofdpa_color_based_ctr_mod_msg_block_index_get(
    ofdpa_color_based_ctr_mod_msg_t *obj,
    uint32_t *block_index)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set block_index in an object of type ofdpa_color_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_mod_msg.
 * @param block_index The value to write into the object
 */
void
ofdpa_color_based_ctr_mod_msg_block_index_set(
    ofdpa_color_based_ctr_mod_msg_t *obj,
    uint32_t block_index)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get transmit_packets from an object of type ofdpa_color_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_mod_msg.
 * @param transmit_packets Pointer to the child object of type
 * uint64_t to be filled out.
 *
 */
void
ofdpa_color_based_ctr_mod_msg_transmit_packets_get(
    ofdpa_color_based_ctr_mod_msg_t *obj,
    uint64_t *transmit_packets)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set transmit_packets in an object of type ofdpa_color_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_mod_msg.
 * @param transmit_packets The value to write into the object
 */
void
ofdpa_color_based_ctr_mod_msg_transmit_packets_set(
    ofdpa_color_based_ctr_mod_msg_t *obj,
    uint64_t transmit_packets)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get receive_packets from an object of type ofdpa_color_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_mod_msg.
 * @param receive_packets Pointer to the child object of type
 * uint64_t to be filled out.
 *
 */
void
ofdpa_color_based_ctr_mod_msg_receive_packets_get(
    ofdpa_color_based_ctr_mod_msg_t *obj,
    uint64_t *receive_packets)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set receive_packets in an object of type ofdpa_color_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_mod_msg.
 * @param receive_packets The value to write into the object
 */
void
ofdpa_color_based_ctr_mod_msg_receive_packets_set(
    ofdpa_color_based_ctr_mod_msg_t *obj,
    uint64_t receive_packets)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get color from an object of type ofdpa_color_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_mod_msg.
 ...
 */
void
ofdpa_color_based_ctr_mod_msg_color_get(
    ofdpa_color_based_ctr_mod_msg_t *obj,
    uint8_t *color)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set color in an object of type ofdpa_color_based_ctr_mod_msg.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_mod_msg.
 * @param color The value to write into the object
 */
void
ofdpa_color_based_ctr_mod_msg_color_set(
    ofdpa_color_based_ctr_mod_msg_t *obj,
    uint8_t color)
{
    of_wire_buffer_t *wbuf;
...
static void
ofdpa_color_based_ctr_multipart_reply_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_3:
...
/**
 * \defgroup ofdpa_color_based_ctr_multipart_reply ofdpa_color_based_ctr_multipart_reply
 */
 ...
 */
static inline int
ofdpa_color_based_ctr_multipart_reply_push_wire_values(ofdpa_color_based_ctr_multipart_reply_t *obj)
{

    ofdpa_color_based_ctr_multipart_reply_push_wire_types(obj);
...
/**
 * Create a new ofdpa_color_based_ctr_multipart_reply object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
ofdpa_color_based_ctr_multipart_reply_t *
ofdpa_color_based_ctr_multipart_reply_new(of_version_t version)
{
    ofdpa_color_based_ctr_multipart_reply_t *obj;
    int bytes;

    bytes = of_object_fixed_len[version][OFDPA_COLOR_BASED_CTR_MULTIPART_REPLY] + of_object_extra_len[version][OFDPA_COLOR_BASED_CTR_MULTIPART_REPLY];

    /* Allocate a maximum-length wire buffer assuming we'll be appending to it. */
    if ((obj = (ofdpa_color_based_ctr_multipart_reply_t *)of_object_new(OF_WIRE_BUFFER_MAX_LENGTH)) == NULL) {
        return NULL;
    }

    ofdpa_color_based_ctr_multipart_reply_init(obj, version, bytes, 0);

    if (ofdpa_color_based_ctr_multipart_reply_push_wire_values(obj) < 0) {
        FREE(obj);
        return NULL;
    }
...
/**
 * Initialize an object of type ofdpa_color_based_ctr_multipart_reply.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
ofdpa_color_based_ctr_multipart_reply_init(ofdpa_color_based_ctr_multipart_reply_t *obj,
    of_version_t version, int bytes, int clean_wire)
{

    LOCI_ASSERT(of_object_fixed_len[version][OFDPA_COLOR_BASED_CTR_MULTIPART_REPLY] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OFDPA_COLOR_BASED_CTR_MULTIPART_REPLY;

    /* Set up the object's function pointers */

    obj->wire_type_set = ofdpa_color_based_ctr_multipart_reply_push_wire_types;
...
/**
 * Create a new ofdpa_color_based_ctr_multipart_reply object and bind it to an existing message
 *
 * @param msg The message to bind the new object to
 * @return Pointer to the newly create object or NULL on error
 *
...
{
    ofdpa_color_based_ctr_multipart_reply_t *obj = NULL;
    of_version_t version;
    int length;
    ...
    if ((obj = (ofdpa_color_based_ctr_multipart_reply_t *)of_object_new(-1)) == NULL) {
        return NULL;
    }

    ofdpa_color_based_ctr_multipart_reply_init(obj, version, 0, 0);
...
/**
 * Get xid from an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param xid Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
ofdpa_color_based_ctr_multipart_reply_xid_get(
    ofdpa_color_based_ctr_multipart_reply_t *obj,
    uint32_t *xid)
{
    of_wire_buffer_t *wbuf;
    ...
    LOCI_ASSERT(obj->object_id == OFDPA_COLOR_BASED_CTR_MULTIPART_REPLY);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set xid in an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param xid The value to write into the object
 */
void
ofdpa_color_based_ctr_multipart_reply_xid_set(
    ofdpa_color_based_ctr_multipart_reply_t *obj,
    uint32_t xid)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get experimenter from an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param experimenter Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
ofdpa_color_based_ctr_multipart_reply_experimenter_get(
    ofdpa_color_based_ctr_multipart_reply_t *obj,
    uint32_t *experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set experimenter in an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param experimenter The value to write into the object
 */
void
ofdpa_color_based_ctr_multipart_reply_experimenter_set(
    ofdpa_color_based_ctr_multipart_reply_t *obj,
    uint32_t experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get subtype from an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param subtype Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
ofdpa_color_based_ctr_multipart_reply_subtype_get(
    ofdpa_color_based_ctr_multipart_reply_t *obj,
    uint32_t *subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set subtype in an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param subtype The value to write into the object
 */
void
ofdpa_color_based_ctr_multipart_reply_subtype_set(
    ofdpa_color_based_ctr_multipart_reply_t *obj,
    uint32_t subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get block_index from an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param block_index Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
ofdpa_color_based_ctr_multipart_reply_block_index_get(
    ofdpa_color_based_ctr_multipart_reply_t *obj,
    uint32_t *block_index)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set block_index in an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param block_index The value to write into the object
 */
void
ofdpa_color_based_ctr_multipart_reply_block_index_set(
    ofdpa_color_based_ctr_multipart_reply_t *obj,
    uint32_t block_index)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get transmit_packets from an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param transmit_packets Pointer to the child object of type
 * uint64_t to be filled out.
 *
 */
void
ofdpa_color_based_ctr_multipart_reply_transmit_packets_get(
    ofdpa_color_based_ctr_multipart_reply_t *obj,
    uint64_t *transmit_packets)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set transmit_packets in an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param transmit_packets The value to write into the object
 */
void
ofdpa_color_based_ctr_multipart_reply_transmit_packets_set(
    ofdpa_color_based_ctr_multipart_reply_t *obj,
    uint64_t transmit_packets)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get receive_packets from an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param receive_packets Pointer to the child object of type
 * uint64_t to be filled out.
 *
 */
void
ofdpa_color_based_ctr_multipart_reply_receive_packets_get(
    ofdpa_color_based_ctr_multipart_reply_t *obj,
    uint64_t *receive_packets)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set receive_packets in an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param receive_packets The value to write into the object
 */
void
ofdpa_color_based_ctr_multipart_reply_receive_packets_set(
    ofdpa_color_based_ctr_multipart_reply_t *obj,
    uint64_t receive_packets)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get color from an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param color Pointer to the child object of type
 * uint8_t to be filled out.
 *
 */
void
ofdpa_color_based_ctr_multipart_reply_color_get(
    ofdpa_color_based_ctr_multipart_reply_t *obj,
    uint8_t *color)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set color in an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param obj Pointer to an object of type ofdpa_color_based_ctr_multipart_reply.
 * @param color The value to write into the object
 */
void
ofdpa_color_based_ctr_multipart_reply_color_set(
    ofdpa_color_based_ctr_multipart_reply_t *obj,
    uint8_t color)
{
    of_wire_buffer_t *wbuf;

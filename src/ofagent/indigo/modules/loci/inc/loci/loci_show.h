...
#ifdef OFDPA_FIXUP
#define LOCI_SHOW_u64_tunnel_id_mask(writer, cookie, val) LOCI_SHOW_x64(writer, cookie, val)
#endif /* OFDPA_FIXUP */
...
#ifdef OFDPA_FIXUP
#define LOCI_SHOW_u64_tunnel_id_match(writer, cookie, val) LOCI_SHOW_x64(writer, cookie, val)
#define LOCI_SHOW_u64_tunnel_id_write(writer, cookie, val) LOCI_SHOW_x64(writer, cookie, val)
#endif /* OFDPA_FIXUP */

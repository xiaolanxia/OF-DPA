...
extern of_oxm_tunnel_id_t *
    of_oxm_tunnel_id_new_tracking(of_version_t version,
        const char *file, int line);
#define of_oxm_tunnel_id_new(version) \
    of_oxm_tunnel_id_new_tracking(version, \
        __FILE__, __LINE__)

extern of_oxm_tunnel_id_masked_t *
    of_oxm_tunnel_id_masked_new_tracking(of_version_t version,
        const char *file, int line);
#define of_oxm_tunnel_id_masked_new(version) \
    of_oxm_tunnel_id_masked_new_tracking(version, \
        __FILE__, __LINE__)
#endif /* OFDPA_FIXUP */
...
#ifdef OFDPA_FIXUP
#define of_oxm_tunnel_id_masked_new(version) \
    of_oxm_tunnel_id_masked_new_(version)
#endif /* OFDPA_FIXUP */
...
#ifdef OFDPA_FIXUP
    of_oxm_tunnel_id_t of_oxm_tunnel_id;
    of_oxm_tunnel_id_masked_t of_oxm_tunnel_id_masked;
#endif /* OFDPA_FIXUP */

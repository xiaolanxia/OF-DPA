...
typedef enum of_object_id_e {
    ...
    OF_OBJECT_COUNT = 363
#else
    OF_OXM_TUNNEL_ID = 363,
    OF_OXM_TUNNEL_ID_MASKED = 364,
    OF_OBJECT_COUNT = 365
#endif /* OFDPA_FIXUP */
...
#define OF_OXM_VALID_ID(id) \
    (((id) >= OF_OXM_FIRST_ID && \
     (id) <= OF_OXM_LAST_ID) || (id) == OF_OXM_TUNNEL_ID || (id) == OF_OXM_TUNNEL_ID_MASKED)
#endif /* OFDPA_FIXUP */
...
#else
    OF_OXM_INDEX_TUNNEL_ID = 38, /* Logical Port Metadata. OF 1.3.1 specification*/ 
    OF_OXM_INDEX_BSN_VRF = 39,
    OF_OXM_INDEX_BSN_GLOBAL_VRF_ALLOWED = 40,
    OF_OXM_INDEX_BSN_L3_INTERFACE_CLASS_ID = 41,
    OF_OXM_INDEX_BSN_L3_SRC_CLASS_ID = 42,
    OF_OXM_INDEX_BSN_L3_DST_CLASS_ID = 43
#endif /* OFDPA_FIXUP */
};

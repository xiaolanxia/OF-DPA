...
#define IND_OFDPA_BFD_DISCRIMINATOR           ((unsigned long long) 1 << 50)
...
#define IND_OFDPA_ACT_CLASS_BASED_TX_COUNT               (1 << 27)
#define IND_OFDPA_ACT_CLASS_BASED_RX_COUNT               (1 << 28)
#define IND_OFDPA_ACT_COLOR_BASED_TX_COUNT               (1 << 29)
#define IND_OFDPA_ACT_COLOR_BASED_RX_COUNT               (1 << 30)
...
#define IND_OFDPA_INJECTED_OAM_FLOW_MATCH_BITMAP  (IND_OFDPA_LMEP_ID)
#define IND_OFDPA_INJECTED_OAM_FLOW_MATCH_MAND_BITMAP  (IND_OFDPA_INJECTED_OAM_FLOW_MATCH_BITMAP)
...
#define IND_OFDPA_MP_FLOW_MATCH_MAND_BITMAP       (IND_OFDPA_ETHER_TYPE | IND_OFDPA_PORT)
...
#define IND_OFDPA_MPLS_MP_FLOW_MATCH_MAND_BITMAP  (IND_OFDPA_MPLS_MP_FLOW_MATCH_BITMAP)

#define IND_OFDPA_DSCP_TRUST_FLOW_MATCH_BITMAP    (IND_OFDPA_QOS_INDEX | IND_OFDPA_IP_DSCP | \
                                                   IND_OFDPA_MPLS_L2_PORT)
#define IND_OFDPA_DSCP_TRUST_FLOW_MATCH_MAND_BITMAP     (IND_OFDPA_QOS_INDEX | IND_OFDPA_IP_DSCP)
...
#define IND_OFDPA_PCP_TRUST_FLOW_MATCH_MAND_BITMAP      (IND_OFDPA_QOS_INDEX | IND_OFDPA_VLAN_PCP | IND_OFDPA_VLAN_DEI)
...
#define IND_OFDPA_EGRESS_VLAN_FLOW_MATCH_BITMAP   (IND_ONF_ACTSET_OUTPUT | IND_OFDPA_VLANID | IND_OFDPA_ALLOW_VLAN_TRANSLATION)
#define IND_OFDPA_EGRESS_VLAN_FLOW_MATCH_MAND_BITMAP   (IND_OFDPA_EGRESS_VLAN_FLOW_MATCH_BITMAP)  /* all fields mandatory */
